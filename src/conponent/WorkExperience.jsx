...
function Card({ card, onClick }) {
  return (
    <motion.div
      ...
      className={`relative bg-white  cursor-pointer w-auto h-auto flex flex-col lg:w-[400px] lg:p-[28px] shadow-[10px] rounded-[14px] lg:rounded-[28px] overflow-hidden lg:overflow-visible  lg:hover:${card.backgroundColor}/20`}
          ...
          >
            <div className='relative flex items-center justify-center w-full h-full '>
              ...
              {isOpen && (
                ...
                >
                  <motion.div className='relative z-0 flex  lg:rounded-[28px] flex-wrap scrollbar-hide max-h-[100vh] lg:max-h-[80vh]  w-full gap-y-[50px]  justify-center items-start bg-white shadow-lg  overflow-auto lg:overflow-hidden'>
                    <motion.div
