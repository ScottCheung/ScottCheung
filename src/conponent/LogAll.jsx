...
const LogEntry = ({ entry }) => (
  ...
  >
    <span
      className={`absolute flex items-center justify-center ${headerHeight} bg-blue-100 rounded-full ring-2 ring-white dark:ring-gray-900 dark:bg-blue-900`}
    >
  ...
  return (
    ...
    >
      <div className="flex flex-col w-full h-full">
        ...
        >
          <ol
            className={`relative border-blue-200 ${iconoffset} border-s-2 dark:border-gray-700`}
          >
