...
const container = Database.Animation.Variant.WelcomeContainer
...
function StudyExperience() {
                              ...
                              <div className="icon-card-content">
                                ...
                                <div className="copy-container">
                                  <div style={{ animationDelay: `${index * 0.2}s` }} class='flex flex-col items-start animate__animated animate__zoomIn  justify-start flex mb-3'>
                                    <div class="typography-card-headline">{`${Experience.major[0]}`}  </div>
                                    <div class="typography-card-headline">{Experience.major[1]}</div>
                                  </div>
                                  ...
                                  <p style={{ animationDelay: `${index * 0.3}s` }} class="mt-7 animate__animated  animate__fadeInUp  card-description text-justify ">{Experience.description}</p>
                                </div>
                              </div>
                            </div>
                          </div>
  ...
  return (
    <LazyMotion features={domAnimation}>
      <m.div className='min-h-[850px] lg:h-[100vh]'>
        {StudyExperience}
      </m.div>
    </LazyMotion>
  );
