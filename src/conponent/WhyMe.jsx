...
function WhyMe({ hideTittle }) {
                    ...
                    >
                      <div className='icon-card card-visblecontainer'>
                        <div className='card'>
                          <div
                            className={`${
                              hideTittle
                                ...
                                : 'bg-white/20 '
                            }  card-modifier  fixed-width bg-button`}
                            style={
                              !hideTittle
                                ? {
                                    ...bgPic(
                          ...
                          >
                            <div
                              className={` card-modifier card-padding has-trigger-button fixed-width bg-button`}
                              style={
                                !hideTittle
                                  ? {
                                      ...bgPic(
                                ...
                                <div className='icon-card-content'>
                                  ...
                                  >
                                    <div
                                      ...
                                      className={`text-full  my-7 animate__animated  animate__fadeInUp  card-description text-justify `}
                                    >
                                      {feature.description}
                                    </div>
                                    <More
                        ...
                        <a className='anz-card-modal-link' href={feature.href}>
                          <button
                              ...
                              <span
                                className={`${
                                  hideTittle
                                    ? `${
                                        feature.color1 + ' ' + feature.color2
                                      } bg-gradient-to-r card-cta-modal-button-icon opacity-80`
  ...
  return <div className='mb-[10vh]'>{WhyMe}</div>;
}
