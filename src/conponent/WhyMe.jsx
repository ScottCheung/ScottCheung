                                ...
                                <div className="">
                                  <div className={``}>
                                    <div className="items-center flex justify-start">
                                      <i style={{ animationDelay: `${index * 0.2}s` }} className={`${feature.icon} fi animate__animated animate__delay-3s  animate__zoomIn animate__slow text-6xl ${feature.color1+" "+feature.color2} flex-shrink-0 bg-clip-text text-transparent bg-gradient-to-r`}></i>
                                    </div>
                                    <div className='py-6 sm:py-3 flex justify-start'>
                                      <div style={{ animationDelay: `${index * 0.2}s` }} className={`animate__animated  animate__delay-3s animate__zoomIn animate__slow typography-card-headline ${feature.color1+" "+feature.color2} flex-shrink-0 bg-clip-text text-transparent bg-gradient-to-r`}>{feature.advantage}</div>
                                    </div>
                                  </div>
                                </div>
                        ...
                        <a className="anz-card-modal-link"
                          ...
                          <button
                            ...
                            <div className="modal-trigger-visblecontainer">
                              <span className={`${hideTittle? `${feature.color1+" "+feature.color2} bg-gradient-to-r card-cta-modal-button-icon opacity-80`:'card-cta-modal-button-icon'}  `}>
