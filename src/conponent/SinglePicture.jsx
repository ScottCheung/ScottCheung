    ...
    <div className='bg-black'>
      ...
      <div className='hidden'>
        ...
        <img
          ...
          alt='prevThumbnail'
        />
        {/* <img loading="lazy" src={SelectedPictureDate[nextIndex+1]} alt="preload" />
        <img loading="lazy" src={SelectedPictureDate[nextIndex+2]} alt="preload" />
        <img loading="lazy" src={SelectedPictureDate[nextIndex+3]} alt="preload" />
        <img loading="lazy" src={SelectedPictureDate[nextIndex+4]} alt="preload" />
        <img loading="lazy" src={SelectedPictureDate[nextIndex+5]} alt="preload" />
        <img loading="lazy" src={SelectedPictureDate[nextIndex+6]} alt="preload" /> */}
      </div>
    </div>
  );
}
