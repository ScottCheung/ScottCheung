                                  ...
                                  <div className="card-viewport-content">
                                    <div className="icon-card-content">
                                      ...
                                      <div className="copy-visblecontainer">
                                        <div className={`typography-card-headline ${isOut? "bg-gray":"text-white"}`}>{type.type[lang]} </div>
                                        <p style={{ animationDelay: `${index * 0.3}s` }} className={`mt-7 animate__animated  animate__fadeInUp  card-description text-justify ${isOut? "bg-gray":"text-white"}`}>{type.name}</p>
                                      </div>
                                    </div>
                                  </div>
                                </div>
                      ...
                      <motion.div
                        ...
                        {codes.map((code, index) => (
                          <motion.div
                            ...
                            <div data-popover id={`code-${index}`} role="tooltip" className="absolute z-10 invisible rounded-[14px] inline-flex w-64 text-white transition-opacity duration-300 backdrop-blur-md bg-black/20 shadow-2xl opacity-0 dark:text-gray-400 dark:border-gray-600 dark:bg-gray-800">
