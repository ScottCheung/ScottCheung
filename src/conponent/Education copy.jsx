                                ...
                                <div className="flex-shrink-0">
                                  ...
                                  <div className="flex justify-start py-10 space-x-3">
                                    <div
                                      ...
                                      className="inline-flex px-5 py-1 text-[10px] font-medium text-white rounded-3xl animate__animated animate__zoomIn animate__slow bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 category"
                                    >
                                      {Experience.tag[lang][0]}
                                    </div>
                                    {Experience.tag[lang][1] && (
                                      <div className="inline-flex px-5 py-1 text-[10px] font-medium text-white rounded-3xl animate__animated animate__zoomIn animate__slow bg-gradient-to-br from-emerald-500 to-sky-500 ">
                                        {Experience.tag[lang][1]}
                                      </div>
                                    )}
                                  </div>
                              ...
                              <div className="copy-visblecontainer">
                                ...
                                <div className={`${simpleVer ? "hidden" : ""}`}>
                                  <span
                                    ...
                                    className="px-5 py-1 font-medium text-center text-white rounded-3xl animate__animated card-description animate__zoomIn category bg-sky-900 ring-1 ring-inset ring-gray-900/10 hover:bg-gray-700"
                                  >
                                  ...
                                  <p
                                    ...
                                    className="text-gray-600 mt-7 animate__animated animate__fadeInUp card-description dark:text-gray-50"
                                  >
