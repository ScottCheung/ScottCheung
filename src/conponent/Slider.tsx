  ...
  (
    {
      ...
      disabled = false,
      onValueChange,
      trackColor = "bg-gray-200", // 这是
      filledTrackColorFrom = "sky-400",
      filledTrackColorTo = "sky-600",
      thumbColor = "bg-sky-50",
      thumbBorderColor = "border-sky-500",
  ...
  ) =>
  {
    ...
    return (
      <div
        ...
        { ...props }
      >
        <div className={ `absolute -translate-x-1/2 h-6 w-6 rounded-full bg-[${ filledTrackColorFrom }] bg-sky-400 ` } />
