    ...
    <motion.div className=' grid visblecontainer section-sapphire py-48  z-50'>
      ...
      <motion.div className='transition-all   grid-item large-span-12 tile-body-no-pad-left tile-body-no-pad-right tile-body-no-pad-bottom grid-item-stickers  z-50 -mt-[20vh] '>
        ...
        >
          ...
          >
            ...
            <span className='absolute  top-0 bottom-0 left-0  right-0 bg-black/20 z-10'></span>
            <motion.div
              initial={{ opacity: 0 }}
                    ...
                    >
                          ...
                          {lang == 0 && (
                            <motion.div>
                              <p className='py-10  text-[17px] '>
                                ...
                                I am dedicated to crafting modern applications
                                that are not only visually appealing and elegant
                                but also powerful in functionality.
                              </p>
                      ...
                      <motion.div className='pt-[70px] pb-[140px]'>
                        <motion.div
                          ...
                          whileInView='visible'
                          viewport={{ once: true }}
                          className='justify-center items-center w-full h-full grid grid-cols-5 '
                        >
                    ...
                    >
                      ...
                      <motion.div className='pt-[70px] pb-[140px]'>
                        <motion.div
                          ...
                          whileInView='visible'
                          viewport={{ once: true }}
                          className='justify-center items-center w-full h-full grid grid-cols-5 content-center'
                        >
                            ...
                            <motion.div>
                              ...
                              <ul className=' text-[17px] '>
                                ...
                                <li>
                                  ...
                                  valuable insights from complex datasets. This
                                  aids in informed decision-making and strategy
                                  development.
                                </li>
                              </ul>
                            </motion.div>
                            ...
                            <motion.div>
                              ...
                              <ul className=' text-[17px] '>
                                <li>
                                  ...
                                  algorithms, I specialize in their application
                                  to analyze and interpret data, make
                                  predictions, and optimize decision-making
                                  processes. From regression and clustering to
                                  classification models, I am well-versed in
                                ...
                                <li>
                                  ...
                                  leverage neural networks to handle complex
                                  tasks such as image recognition, natural
                                  language processing, and pattern recognition.
                                  I have practical experience implementing
                                  convolutional neural networks (CNNs) and
                                  recurrent neural networks (RNNs) in real-world
                                  scenarios.
                                </li>
                                <li>
                                  <strong className='font-black py-4'>
                                  ...
                                  generate human-like language. This includes
                                ...
                                <li>
                                  ...
                                  preferences and behavior to provide
                            ...
                            <motion.div>
                              ...
                              <ul className=' text-[17px] '>
                                ...
                                <li>
                                  ...
                                  different environments and facilitates
          ...
          >
            ...
            <motion.div className='tile-body'>
              <motion.div
                ...
                whileInView='visible'
                // viewport={{ once: true }}
                className=' justify-center items-center w-full h-full grid grid-cols-4 content-center mb-24 bg-white/30 p-20 rounded-[18px]'
              >
                {apps.map((app, index) => (
                  <motion.div
                    key={index}
      ...
      >
        <motion.div className='tile tile-rounded'>
          {/* 半透明要改 */}
          <motion.div className='tile-content bg-white/30'>
            {/* Front-end */}
      ...
      <motion.div
        ...
        id={`infj`}
        role='tooltip'
        className='m-[20px] absolute z-50 invisible rounded-[28px] flex w-[300px] md:w-[400px] lg:w-[800px]  transition-opacity duration-300 backdrop-blur-lg bg-white/50 shadow-2xl opacity-0 dark:text-gray-400 dark:border-gray-600 dark:bg-gray-800'
      >
