      ...
      >
        ...
        >
          <motion.div
            ...
            className='tile-content bg-gray-950/90 transition-all   h-auto min-h-[100vh]'
            style={{
          ...
          >
            ...
            >
              <motion.span
                id='blackOverlay'
                className='w-full h-full absolute opacity-75 bg-black transition-all    '
              ></motion.span>
              <motion.div
                layout
                initial={{ opacity: 0 }}
              ...
              <motion.div layout className='z-30  '>
                <motion.ul
                  ...
                  // viewport={{ once: true }}
                  layout
                  className=' tile-header flex  relative justify-between min-h-[100px]  text-center  w-full pt-[15px] gap-x-[50px] overflow-auto  scrollbar-hide'
                >
                  {tabs.map((tab, index) => (
                    <motion.button
                      key={tab.label}
                      ...
                      className={`transition-all inline-flex  items-start ${
                        tab === selectedTab
                          ? ' text-[14px] md:text-[20px] lg:text-[23px]'
                          : '  text-[12px] md:text-[17px] lg:text-[20px]'
                      } tile-headline typography-subsection-headline `}
                      onClick={() => setSelectedTab(tab)}
                    >
                      <div className='flex flex-col'>
                        <h3
                          className={`bg-gradient-to-r text-transparent bg-clip-text from-${tab.color1} to-${tab.color2}`}
                        >
                          {tab.label[lang]}
                        </h3>
                        {tab === selectedTab ? (
                          <motion.div
                            ...
                            className={`from-${tab.color1} to-${tab.color2} bg-gradient-to-r w-full   h-[6px] mt-[15px] rounded-full z-50`}
                            layoutId='underline'
                          />
                        ) : null}
                      </div>
                      {/* <motion.button
                        className={`flex w-full md:min-h-[20px] lg:min-h-[30px] `}
                      > */}
                            ...
                            {lang == 0 && (
                              <motion.div>
                                <p className='py-10  text-[17px] '>
                                  ...
                                  design and user experience. I am dedicated to
                                  crafting modern applications that are not only
                                  visually appealing and elegant but also
                                ...
                                <ul className=' text-[17px] '>
                                  ...
                                  <li>
                                    ...
                                    , a practical CSS framework. In addition, I
                                    am skilled in mainstream UI libraries such
                                    as Bootstrap and MUI, enabling me to quickly
                                    and flexibly construct modern user
                                    interfaces.
                                  </li>
                                  <li>
                                    <strong className='font-black py-4'>
                                    ...
                                    users with a smooth interactive experience.
                                  </li>
                                </ul>
                              </motion.div>
                            )}
                          ...
                          >
                            {frontEnd.map((app, index) => (
                              ...
                              >
                                ...
                                <motion.div className='text-[7px] md:text-[12px] font-semibold lg: text-[17px] text-center pt-[20px] from-red-500 to-red-700 bg-gradient-to-r text-transparent bg-clip-text'>
                                  {app.name}
                                </motion.div>
                              </motion.div>
                            ))}
                    ...
                    {(selectedTab.label[lang] == 'Backend' ||
                      ...
                      <motion.div className='flex w-full flex-col'>
                        ...
                        <motion.div className=' mt-[20px] '>
                          <h3 className='tile-headline typography-subsection-headline from-orange-500 to-amber-500 bg-gradient-to-r text-transparent bg-clip-text transition-all  '>
                            {lang == 0 && 'Backend'}
                            {lang == 1 && '后端'}
                          </h3>
                              ...
                              <motion.div>
                                ...
                                <ul className=' text-[17px]'>
                                  ...
                                  <li>
                                    ...
                                    , ensuring seamless data interchange between
                          ...
                          >
                            {BackendEnd.map((app, index) => (
                              ...
                              >
                                ...
                                <motion.div className='text-[7px] md:text-[12px] font-semibold lg: text-[17px] text-center pt-[20px] from-orange-500 to-amber-500  bg-gradient-to-br text-transparent bgrid-colslip-text'>
                                  {app.name}
                                </motion.div>
                              </motion.div>
                            ))}
                              ...
                              <motion.div>
                                ...
                                <ul className=' text-[17px] '>
                                  <li>
                                    ...
                                    sorting based on conditions. I am proficient
                                    in CRUD operations and other essential
                                  ...
                                  <li>
                                    ...
                                    PostgreSQL, utilizing it to construct robust
                                    and scalable database solutions. My
                                  ...
                                  <li>
                                    ...
                                    optimized database architectures tailored to
                                    the specific requirements of diverse
                                    applications.
                                  </li>
                                  <li>
                                    <strong className='font-black py-4'>
                                    ...
                                    enhancing the interpretability of processed
                                    data.
                                  </li>
                                  <li>
                                    <strong className='font-black py-4'>
                          ...
                          >
                            {database.map((app, index) => (
                              ...
                              >
                                ...
                                <motion.div className='text-[7px] md:text-[12px] font-semibold lg: text-[17px] text-center pt-[20px] from-sky-500 to-emerald-500 bg-gradient-to-r text-transparent bg-clip-text'>
                                  {app.name}
                                </motion.div>
                              </motion.div>
                            ))}
                              ...
                              <motion.div>
                                ...
                                <ul className=' text-[17px] '>
                                  ...
                                  <li>
                                    ...
                                    My expertise extends to deep learning, where
                                    I leverage neural networks to handle complex
                                    tasks such as image recognition, natural
                                    language processing, and pattern
                                  ...
                                  <li>
                                    ...
                                    I am adept at developing algorithms that
                                    enable applications to understand,
                                    interpret, and generate human-like language.
                                    This includes text classification, sentiment
                                    analysis, and language generation models.
                                  </li>
                                  <li>
                                    <strong className='font-black py-4'>
                                      Recommender Systems:
                                    ...
                                    filtering, content-based filtering, and
                                    hybrid approaches. My focus is on analyzing
                                    user preferences and behavior to provide
                          ...
                          >
                            {algorithm.map((app, index) => (
                              ...
                              >
                                ...
                                <motion.div className='text-[7px] md:text-[12px] font-semibold lg: text-[17px] text-center pt-[20px] from-cyan-500 bg-gradient-to-r to-blue-500 text-transparent bgrid-colslip-text'>
                                  {app.name}
                                </motion.div>
                              </motion.div>
                            ))}
                            ...
                            {lang == 0 && (
                              <motion.div>
                                <p className='py-10  text-[17px] '>
                                  ...
                                  comprehensive project execution. Here are some
                                  additional areas where I excel:
                                </p>
                                <ul className=' text-[17px] '>
                                  <li>
                                    <strong className='font-black py-4'>
                                  ...
                                  <li>
                                    ...
                                    communication. This enhances the security
                          ...
                          >
                            {other.map((app, index) => (
                              ...
                              >
                                ...
                                <motion.div className='text-[7px] md:text-[12px] font-semibold lg: text-[17px] text-center pt-[20px] from-indigo-500 to-pink-500 bg-gradient-to-r text-transparent bg-clip-text'>
                                  {app.name}
                                </motion.div>
                              </motion.div>
                            ))}
