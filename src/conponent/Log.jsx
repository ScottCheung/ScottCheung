...
export default function Log() {
  ...
  return (
    <div
      id="log-window"
      className="fixed top-0 left-0 z-50 flex items-center justify-center w-full h-full bg-gray-800 bg-opacity-75 backdrop-blur-md"
      onClick={handleClose}
    >
      <motion.div
        className={`relative lg:w-3/4 w-full  lg:max-h-[90vh]  lg:max-w-7xl bg-white ${globalBradius} ${globalBpadding} shadow-lg`}
