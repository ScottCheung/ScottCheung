              ...
              <div className="flex  justify-center mb-15 -mt-[50px]">
                <div className=" ">
                  <motion.div
                    ...
                    <div className={`flex justify-center items-center ${selectedWhyMeItem.color1+" "+selectedWhyMeItem.color2} bg-gradient-to-r rounded-full w-[100px] h-[100px] border border-white border-[4px]`}>
                      <i className={`fi text-white text-[50px] mt-[10px] ${selectedWhyMeItem.icon}`}></i>
                    </div>
                  </motion.div>
                </div>
              </div>
