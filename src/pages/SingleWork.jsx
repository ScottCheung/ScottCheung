...
export default function singleWork() {
  ...
  const selectedWhyMeItem = database.PersonalInfo.WorkExperience.find(item => item.id === extractedValue);
  ...
  style={(windowWidth < 768) && { ...bgPic(selectedWhyMeItem.pic, "600px auto", "bottom center") } || null}>
        ...
        <motion.div
          ...
          viewport={{ once: true }}
          className={`visblecontainer ${windowWidth > 768? "mb-[100px]":""}  `}>
          <motion.div
                ...
                <div className=" ">
                  <motion.div
                    ...
                    <div className={`flex justify-center items-center  w-[150px] h-[150px]  }  `}>
                      <img src={selectedWhyMeItem.logo} className={`outline outline-white outline-[4px] bg-white ${selectedWhyMeItem.logoRound=="rounded"? "rounded-full":"rounded-[10px]"}  shadow-2xl`}></img>
                    </div>
                  </motion.div>
                </div>
              </div>
