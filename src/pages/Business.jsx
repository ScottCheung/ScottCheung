...
export default function material() {
  ...
  return (
      ...
      <div
        className="welcome-video-wall-visblecontainer w-full flex justify-center py-16 flex-col z-50 bg-sky-100 bg-cover bg-center sticky top-0 shadow-2xl" 
        >
    ...
    <section
            className="section section-welcome no-pad-bottom"
          >
            <div className='welcome-video-wall-visblecontainer visblecontainer h-auto'>
                ...
                <motion.table
                  ...
                  {BS[0].courses.map((subject, index) => (
                                        <motion.tbody
                                        key={index}
                                        variants={item}
    ...
    <StudyExperience hideTittle={true}/>
  </main>
</div>
</>
  )
