...
export default function Example() {
  ...
  return (
      ...
      <div
        className="welcome-video-wall-container w-full flex justify-center py-16 flex-col z-50 bg-sky-100 bg-cover bg-center sticky top-0 shadow-2xl" 
        >
