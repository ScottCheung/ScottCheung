...
\newcommand{\placelastupdatedtext}{% \placetextbox{<horizontal pos>}{<vertical pos>}{<stuff>}
  \AddToShipoutPictureFG*{% Add <stuff> to current page foreground
    \put(
        ...
        \small\color{gray}\textit{Check Update}\hspace{\widthof{Check Update}}
    }}}%
  }%
}%
...
\begin{document}
    ...
    \begin{header}
        ...
        \normalsize
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{tel:+61 434344292}{{\footnotesize\faPhone*}\hspace*{0.13cm}+61 434344292}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{mailto:xianzhe.site@gmail.com}{{\footnotesize\faEnvelope[regular]}\hspace*{0.13cm}xianzhe.site@gmail.com}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
        \mbox{\hrefWithoutArrow{https://xianzhe.com/}{{\footnotesize\faLink}\hspace*{0.13cm}xianzhe.com}}%
        \kern 0.25 cm%
        \AND%
        \kern 0.25 cm%
