...
export default function Errorpage() {
  ...
  const latestContact =
    resumeData.header.contacts[resumeData.header.contacts.length - 1];
        ...
        <div className="text-center ">
          ...
          <div className="flex gap-x-[30px] justify-center py-[40px]">
            ...
            <motion.a
              ...
              href={`https://github.com/Xianzhezhang97/CV/raw/main/CV%20%7C%20Scott%20Cheung%20%7C%20sky.pdf`}
              className={button}
            >
