...
export default function Example() {
  ...
  return (
    <div className='bg-gradient-to-b from-pink-100 from-10% via-pink-50 via-50% to-white/0 '>
      <Navbar  />
      <div className='flex justify-center w-full px-[28px] pt-[70px]'>
      <div className="h-[130vh] w-full bg-sky-200 animate__animated animate__zoomIn rounded-[28px] "
        style={{...bgPic('https://3o.hk/images/2024/01/19/LearningAbility.png', "800px auto", "bottom right")}}
        >
