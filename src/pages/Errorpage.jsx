...
const Message ={ 
  ...
  Status: ["This page is currently undergoing maintenance. Please revisit later. We are committed to providing you with a better browsing experience.", "状态：我们正在维护此页面。请稍后再访问。我们致力于为您提供更好的浏览体验。"],
  btn1:["Go home","返回主页"],
  btn1web:"/home",
    ...
    <div >
      ...
      <main className="h-[100vh] bg-gray-900/40 animate__animated animate__fadeIn  place-items-center flex justify-center  px-6 py-24 sm:py-32 lg:px-8">
        <div className="text-center ">
          ...
          className="animate__animated animate__fadeInUp text-[150px] font-semibold text-white">{Message.FirstHeader[lang]}</motion.p>
          <motion.h1 
                            initial={{scale:0.9,y:"60px",opacity:0}}
                            animate={{scale:1,y:"0px",opacity:1}}
                            transition={{duration:0.8}}
          style={{ animationDelay: `0.2s` }} className="animate__animated animate__fadeInUp mt-4 py-[10px] text-6xl font-bold tracking-tight text-gray-200 sm:text-4xl">{Message.SecondHeader[lang]}</motion.h1>
          <motion.p 
                            initial={{scale:0.5,y:"30px",opacity:0}}
                            animate={{scale:1,y:"0px",opacity:1}}
                            transition={{duration:0.9}}
          style={{ animationDelay: `0.3s` }} className="animate__animated animate__fadeInUp mt-6 text-[15px] py-[15px] leading-7 text-gray-200">{Message.Status[lang]}</motion.p>
      ...
      <div  style={{backgroundImage: `url(${Message.bg})`, position:"absolute",
    top: 0,
    bottom: 0,
    left: 0,
    right: 0,
