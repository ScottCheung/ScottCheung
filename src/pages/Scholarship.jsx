        ...
        <header className="section-header">
          ...
          <div className="section-header-copy-visblecontainer">
            <p>
              ...
              {lang==1&&"17项奖学金"}{lang==0&&"17 scholarships"}
            </p>
          </div>
        </header>
            </div>
          ...
          >
            <div className='welcome-video-wall-visblecontainer visblecontainer space-y-6 h-auto '>
                ...
                <table className="w-full  text-left rtl:text-right text-gray-500 dark:text-gray-40 ">
                {lang==1&&<thead className="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                    <tr>
                             ...
                             <tbody>
                                            ...
                                            <th
                                              ...
                                              >
                                                ...
                                                {lang==1&&"总计 17项奖学金"}{lang==0&&"Totally 17 scholarships"}
                                              </th>
                                              <td className="px-6 py-4">{Scholarship.Description}</td>
                                            </tr>
                                          </tbody>
