...
})()(
  {
    1: [
      function (require, module, exports) {
        ...
        var m = [].concat(b(t.KEYS.PATHS.CONFIG), ['global', 'cookieDomain']),
          ...
          O = e.pipe(
            function (t) {
              return e.beaconHelpers.isNotEmpty(t)
                ? s.reduce(function (n, r) {
                    var a = r.sanitizers || [],
                      o = e.pipe.apply(void 0, b(a))(t[r.name]);
                    return o && (n[r.name] = o), n;
                  }, {})
                : null;
            },
            function (t) {
              return e.beaconHelpers.isNotEmpty(t)
                ? s.reduce(
                    function (n, r) {
                      ...
                      return c && o + s <= 500
                        ? ((a[i] = c), { beacon: a, beaconLength: o + s })
                        : { beacon: a, beaconLength: o };
                    },
                    { beacon: {}, beaconLength: 0 },
                  ).beacon
                : null;
            },
          ),
      ...
      function (require, module, exports) {
        ...
        var f = function () {
            var e =
              ...
              r = p({}, e);
            return (
              e.hasOwnProperty(i.EVENTS) &&
                (r[i.EVENTS] = t.parseEventCollectionString(e[i.EVENTS])),
              e.hasOwnProperty(i.PRODUCTS) &&
                (r[i.PRODUCTS] = t.parseProductCollectionString(e[i.PRODUCTS])),
              r
            );
          },
          v = [
            function () {
              var r =
                ...
                a = r.previous,
                o = void 0 === a ? {} : a;
              return e.merge({ target: f(o.beacon), source: f(n.beacon) });
            },
            function () {
              var e =
                  arguments.length > 0 && void 0 !== arguments[0]
            ...
            var c = (function () {
              ...
              return null === n
                ...
                : v.reduce(function (r, t) {
                    var a = t(n);
                    return a && e.merge({ target: r, source: a }), r;
                  }, {});
            })(O[n]);
            return (
              null !== c &&
                (t.beacon = e.merge({ target: t.beacon, source: c })),
              t
            );
          };
            ...
            if (!(r[0].intersectionRatio <= 0)) {
              var o,
                ...
                l =
                  ((o = {}),
                  (a = n.VARS.EVENTS),
                  (i = new e.OmnitureCollection(
                    new e.OmnitureEvent([n.EVENTS.EVENT_406]),
                  )),
                  a in o
                    ...
                    : (o[a] = i),
                  o);
              t.onPageEnd({ beacon: l }), t.engagementObserver.disconnect();
            }
          },
          o = function (e) {
            var n = e.element;
        ...
        (exports.endOfPage = function () {
          ...
          (exports.update = function () {
            t.element instanceof HTMLElement &&
              (t.engagementObserver.disconnect(), o({ element: t.element }));
          });
      },
      {
        '@apple/analytics-omniture-collection': 7,
    ...
    7: [
      function (require, module, exports) {
        ...
        var w = function (t) {
            ...
            var r = e.index;
            return { prefix: t.slice(0, r), number: parseInt(t.slice(r), 10) };
          },
          k = (function () {
            function e(r) {
              i(this, e), (this.key = t.toStrTrim(r));
            }
            return (
              u(e, [
                {
          ...
          P = function () {
            ...
            return e
              .reduce(function (t, e) {
                return (
                  e instanceof x ? t.push.apply(t, g(e.values())) : t.push(e), t
                );
              }, [])
              .filter(function (t) {
          ...
          x = (function (t) {
            ...
            function r() {
              var t, n;
              return (
                i(this, r), (t = n = e.call(this)).merge.apply(t, arguments), n
              );
            }
            return (
              u(r, [
                ...
                },
                {
                  ...
                  value: function () {
                    var t = this;
                    return (
                      P.apply(void 0, arguments).forEach(function (e) {
                        if (e instanceof k) {
                          var r = t.get(e.key);
                          r ? r.merge(e) : t.add(e);
                        }
          ...
          T = (function (e) {
            ...
            function n(t, e) {
              var o;
              return i(this, n), ((o = r.call(this, t)).value = e), o;
            }
            return (
              u(n, [
                {
          ...
          A = (function (e) {
            ...
            function o() {
              ...
              return (
                (a.sku = t.beaconHelpers.guessPartNumber(a.sku)),
          ...
          (exports.parseProductCollectionString = function (t) {
            ...
            return t && 'string' == typeof t
              ? ((function (t) {
                  ...
                  !(function (t, e) {
                    if (!(t instanceof x && e instanceof A)) return t;
                    var r = t.get(e.sku);
                    if (!r) return t.add(e);
    ...
    9: [
      function (require, module, exports) {
        ...
        var l = function (e) {
          ...
          p = function (e) {
            return { global: e.slice(0, 4), session: e.slice(4) };
          },
          v = function (e) {
            return function (t) {
              return t.slice(0, e);
          ...
          w = function (e) {
            return (
              e.options && e.options.version
                ? (e.schema = S(e.options.version))
                : (e.allSchemas = S()),
              e
            );
          },
          ...
          U = function (e) {
            var t = e.schema,
              ...
              c = i(r) ? te({ schema: t, data: r }) : null,
              s = i(n) ? te({ schema: t, data: n }) : null,
              u = i(c) ? p(c.uuid) : null,
              l = i(s) ? p(s.uuid) : null,
              f = i(r) && i(n),
          ...
          M = function () {
            ...
            if (t.allSchemas) {
              for (
                var r = Object.keys(t.allSchemas).sort(function (e, t) {
                    return e < t ? 1 : -1;
                  }),
                  n = {},
                  o = 0;
                ...
                var a = r[o],
                  ...
                  l = T({ api: e, key: s }),
                  f = N({ api: e, key: u }),
                  p = U({ schema: i, cookieData: l, sessionData: f });
          ...
          $ = function () {
            var e =
              ...
              t =
                arguments.length > 1 && void 0 !== arguments[1]
                  ...
                  : O,
              r = { options: e };
            if (!(r = w(r)).allSchemas) return null;
            var n = M(t);
            Object.values(r.allSchemas).forEach(function (e) {
              var n = e.settings,
                ...
                i = { api: t, key: o };
              r.options &&
                r.options.cookieDomain &&
                (i.cookieDomain = r.options.cookieDomain),
                A(i),
                x({ api: t, key: a }),
                C({ api: t });
            }),
              n &&
                n.uuid &&
                f(j, w, re, R)({ data: { uuid: n.uuid }, options: e });
          },
          L = M,
          G = function (e) {
            var t = L();
            return t ? J(e, t) : e.data && (e.data.uuid || q(e)), e;
          },
          J = function (e, t) {
            Object.keys(t).forEach(function (r) {
              var n = t[r],
                o = e.data[r],
                a = B(e, r);
              e.data[r] = z({ storedValue: n, newValue: o, mergePolicy: a });
            });
          },
          q = function (e) {
            e.data.uuid = d();
          ...
          Q = function (e, t) {
            ...
            if (e && t) {
              ...
              return (
                n(
                  analyticsOmnitureConstants.VARS.EVENTS,
                  analyticsOmnitureCollection.parseEventCollectionString,
                ),
                n(
                  analyticsOmnitureConstants.VARS.PRODUCTS,
                  analyticsOmnitureCollection.parseProductCollectionString,
                ),
                r
              );
            }
          ...
          Z = function (e) {
            ...
            if (
              (e.transformed &&
                Object.entries(e.transformed).forEach(function (e) {
                  var r = i(e, 2),
                    o = r[0],
                    a = r[1];
                  t.push(o + n + a);
              ...
              e.transformedSync &&
                Object.entries(e.transformedSync).forEach(function (e) {
                  var t = i(e, 2),
                    o = t[0],
                    a = t[1];
                  r.push(o + n + a);
          ...
          ne = function (e) {
            return function (t) {
              ...
              var r = t.schema.settings.transformers.map(
                  (function (e) {
                    return function (t) {
                      return ee[t](e);
                    };
                    ...
                    case 'sync':
                      if (e.newValue) {
                        var s = N({ api: n, key: r }),
                          u = e.newValue;
                        if (s) {
                          var l = te({ schema: t, data: s }),
                            f = te({ schema: t, data: e.newValue }),
                            d = p(l.uuid),
                            y = p(f.uuid),
        ...
        var cookieDomain = null,
          ...
          store = function (e) {
            ...
            if ('page' === t) {
              var o = { version: MULE_VERSION },
                ...
                i = getCookieDomain();
              return (
                null !== i && (a.cookieDomain = i),
                void oe({ data: _defineProperty({}, r, n), options: o })
              );
            }
          ...
          retrieve = function () {
            ...
            return dataStore.hasOwnProperty(t)
              ? null === n
                ? dataStore[t] || null
                : dataStore[t][n] || null
              : null;
        ...
        (exports.getBeacon = function (n) {
          ...
          return (
            Array.isArray(e) &&
              e.forEach(function (n) {
                t(n) &&
                  (c[n]
                    ? ((a.events = s(a.events, n)),
                      (a.eVar17 = v(a.eVar17, c[n])))
                    : o &&
                      o[n] &&
                      ((a.events = s(a.events, n)),
          ...
          (exports.relayRead = function () {
            ...
            return (
              ...
              { queryString: u.toString(), beacon: i }
            );
          }),
      ...
      function (require, module, exports) {
          ...
          l = function (t) {
            var n = t.accessoriesLink,
              ...
              a = new e.OmnitureCollection(
                new e.OmnitureEvent(i ? c.COMPLETE : c.SEARCH),
              );
            return (
              0 === o && a.add(new e.OmnitureEvent(c.NO_RESULTS_CLICK)),
        ...
        (exports.accessoriesFilter = function () {
          var r,
            ...
            S = o.analyticsPrefix;
          return (
            E((r = {}), t.VARS.EVAR_2, n.toStrTrim(i).toLowerCase()),
            E(
              r,
              t.VARS.EVAR_4,
            ...
            E(
              r,
              t.VARS.EVENTS,
              new e.OmnitureCollection(
                new e.OmnitureEvent(c.ACCESSORIES_FILTER),
              ),
            ),
            r
          );
          ...
          (exports.begin = function () {
            ...
            return (
              ...
              E(
                r,
                t.VARS.EVENTS,
                new e.OmnitureCollection(new e.OmnitureEvent(c.BEGIN)),
              ),
              r
            );
          }),
          (exports.exit = function () {
            ...
            return (
              ...
              E(
                r,
                t.VARS.EVENTS,
                new e.OmnitureCollection(new e.OmnitureEvent(c.EXIT)),
              ),
              r
            );
          }),
          (exports.pagination = function () {
            ...
            return (
              ...
              E(
                ...
                t.VARS.EVENTS,
                new e.OmnitureCollection(
                  new e.OmnitureEvent(c.SEARCH),
                  new e.OmnitureEvent(c.PAGINATION),
                ),
              ),
              r
            );
          ...
          (exports.resultClick = function () {
            var e,
              ...
              O = r.results,
              N = r.currentPage,
              m = n.toStrTrim(s).toLowerCase(),
              d = 0 === O,
              v = c || !d,
              A = V({ URLObject: R, serviceLink: c, relayId: p }),
              w = l({
                accessoriesLink: o,
                storeLink: i,
                relay: A,
    ...
    12: [
      function (require, module, exports) {
        ...
        var k = function () {
          ...
          L = Object.freeze({ __proto__: null, get: A, set: P }),
          I = function (e) {
            if (!e) return null;
            try {
              return JSON.parse(e);
          ...
          z = Object.freeze({ __proto__: null, decode: I, encode: E }),
          N = c(A, I),
          T = Object.freeze({
            __proto__: null,
            get: N,
          ...
          V = Object.freeze({
            ...
            getPartNumber: function () {
              var e =
                ...
                n = e.parent,
                o = void 0 === n ? null : n,
                i = X({ element: r, parent: o });
              return i || J({ element: r, parent: o }) || null;
            },
          }),
          K = c(m, I),
          B = Object.freeze({
          ...
          te = Object.freeze({ __proto__: null, get: Z, set: Y, remove: ee }),
          re = c(Z, I),
          ne = Object.freeze({
            __proto__: null,
            get: re,
          ...
          me = Object.freeze({ __proto__: null, get: fe, set: pe, remove: ge }),
          ye = c(fe, I),
          ve = Object.freeze({
            __proto__: null,
            get: ye,
          ...
          Se = Object.freeze({
            ...
            getQueryParam: function (e) {
              return window.URL
                ? new URL(window.location).searchParams.get(e)
                : null;
            },
      ...
      function (require, module, exports) {
        ...
        module.exports = function (t, e) {
          ...
          for (
            ...
            (o.top += t.offsetTop), (o.left += t.offsetLeft);
          return {
            top: o.top,
    ...
    34: [
      function (require, module, exports) {
        ...
        (prohref = ElementEngagement.prototype =
          Object.create(Super.prototype)),
          ((prohref = ac_Object.extend(
            proto,
            EventEmitterMicro.prototype,
          ))._decorateTrackedElement = function (e, t) {
            var i;
          ...
          (proto._elementInViewPastThreshold = function (e) {
            return (
              e.pixelsInView === this._windowHeight ||
              e.percentInView > e.inViewThreshold
            );
          }),
          ...
          (proto.start = function (e) {
            e || this._attachAllElementListeners(),
              e &&
                !e.tracking &&
                ((e.stopOnEngaged && e.engaged) ||
                  ((e.tracking = !0), this._attachElementListeners(e))),
              this.tracking
          ...
          (proto.addElement = function (e, t) {
            t = t || {};
            var i = Super.prototype.addElement.call(
              this,
              e,
              t.useRenderedPosition,
            );
      ...
      function (require, module, exports) {
        ...
        function ElementTracker(e, t) {
          (this.options = ac_Object.clone(defaultOptions)),
            ...
            e &&
              (Array.isArray(e) ||
                ac_dom_nodes.isNodeList(e) ||
                ac_dom_nodes.isElement(e)) &&
              this.addElements(e),
            (this.refreshAllElementStates =
              this.refreshAllElementStates.bind(this)),
            (this.refreshAllElementMetrics =
              this.refreshAllElementMetrics.bind(this)),
            this.options.autoStart && this.start();
        }
        var prohref = ElementTracker.prototype;
        (proto.destroy = function () {
          var e, t;
          for (this.stop(), e = 0, t = this.elements.length; e < t; e++)
            this.elements[e].destroy();
          (this.elements = null), (this.options = null);
        }),
          (proto._registerTrackedElements = function (e) {
            [].concat(e).forEach(function (e) {
              this._elementInDOM(e.element) &&
          ...
          (proto._elementPixelsInView = function (e) {
            ...
            return t > this._windowHeight || i < 0
              ? 0
          ...
          (proto.refreshElementMetrics = function (e) {
            ...
            var t = ac_dom_metrics.getDimensions(
                e.element,
                e.useRenderedPosition,
              ),
              i = ac_dom_metrics.getPagePosition(
                e.element,
                e.useRenderedPosition,
              );
          ...
          (proto.refreshElementState = function (e) {
            ...
            var t = e.inView;
            return (
              (e.pixelsInView = this._elementPixelsInView(e)),
    ...
    42: [
      function (require, module, exports) {
        ...
        var prohref = (TrackedElement.prototype = Object.create(superclass));
        (proto.destroy = function () {
    ...
    44: [
      function (require, module, exports) {
        ...
        var prohref = EventEmitterMicro.prototype;
    ...
    49: [
      function (require, module, exports) {
        Array.prototype.forEach ||
          (Array.prototype.forEach = function (o, r) {
            var t,
              a,
              c = Object(this);
      ...
      function (require, module, exports) {
        !(function () {
          function e(e) {
            ...
            return (
              s ? t.setAccount && t.setAccount(e) : (t = new AppMeasurement(e)),
              t
            );
          }
          function t() {
            ...
            if (r)
              for (t = 0; t < r.length; t++)
                (a = e((n = r[t]).oun)).setAccount(n.un),
                  a.setTagvisblecontainer(n.tagvisblecontainerName);
            i.s_giq = 0;
          }
          (window.AppMeasurement_Module_ActivityMap = function (e) {
            ...
            (window.AppMeasurement = function (e) {
              ...
              (t.log = function (e) {
                ...
                (t.vb = function () {
                  return t.useLinkTrackSessionStorage
                    ? t.Fa()
                      ? n.sessionStorage.getItem(t.P)
                      : void 0
                    : t.cookieRead(t.P);
                }),
                (t.Fa = function () {
                ...
                (t.Db = function (e) {
                  t.useLinkTrackSessionStorage
                    ? t.Fa() && n.sessionStorage.setItem(t.P, e)
                    : t.cookieWrite(t.P, e);
                }),
                (t.Wb = function () {
                  if (!t.gc) {
                ...
                (t.u = function (e) {
                  ...
                  for (n in t.Q)
                    if (
                      !Object.prototype[n] &&
                      (a = t.Q[n]) &&
                      (a._olc && a.onLoad && ((a._olc = 0), a.onLoad(t, a)),
                      a[e] && a[e]())
                    )
                      return 1;
                  return 0;
                ...
                (t.sb = function () {
                  return (
                    t.ca || t.G || (t.gb(t.Gb) ? (t.G = !0) : (t.ca = !0)),
                    !(t.ca && !t.G)
                  );
                }),
                (t.qb = function () {
                  ...
                  if (e) {
                    if (!t.ua && !t.ba)
                      return e.fetchPermissions(t.zb, !0), (t.ba = !0), !1;
                    if (!t.ua) return !1;
                ...
                (t.ub = function () {
                  ...
                  return (
                    ...
                    (t.Y &&
                      ((t.Y = !1),
                      t.I || ((t.I = !0), e.getVisitorValues(t.Hb))),
                    !t.I)
                  );
                }),
                (t.T = function () {
                ...
                (t.xb = function () {
                  return (
                    t.aa || t.F || (t.fb(t.Ba) ? (t.F = !0) : (t.aa = !0)),
                    !(t.aa && !t.F)
                  );
                }),
                (t.hb = function () {
              ...
              for (
                o && 'y' == o.x
                    ...
                    (i.C = setTimeout(function () {
                      ...
                      ((t.useForcedLinkTracking && t.J) ||
                        ...
                        (t.forcedLinkTrackingTimeout ||
                          (t.forcedLinkTrackingTimeout = 250),
                  ...
                  t.Za = function () {
                    if (t.trackOffline)
                      for (
                        (!t.offlineLimit || 0 >= t.offlineLimit) &&
                        (t.offlineLimit = 10);
                        t.i.length > t.offlineLimit;
              ...
              (i =
                ...
                (t.d = n.document),
                (t.da = function () {
                  t.ea && (n.clearTimeout(t.ea), (t.ea = a)),
                    t.bodyClickTarget &&
                      t.J &&
            ...
            t(),
            t(),
            (module.exports = { s_gi: e, s_pgicq: t });
        })();
      },
      {},
    ],
        ...
        function init(i) {
          if (i && (!app || !0 === i.options.force))
            return (
              setDefaults(
                i,
                (app = window.s = initSGI(_modifyBucket(i.bucket))),
              ),
      ...
      function (require, module, exports) {
        ...
        class ElementEngagementObserver {
          ...
          attachEventListeners() {
            ...
            let {
              [this.options.startDataAttribute]: e,
              [this.options.endDataAttribute]: n,
            } = t.dataset;
          ...
          startHandler(t) {
            const { detail: e } = t,
              { target: n } = e || t,
              {
                dataset: { analyticsElementEngagement: a },
              } = n;
            a &&
              ((this.engagements[a] = this.engagements[a] || {}),
              this.engagements[a].timeout &&
                clearTimeout(this.engagements[a].timeout),
              (this.options.once && this.engagements[a].hasFired) ||
                (this.engagements[a].timeout = setTimeout(() => {
                  this.track({ engagementTitle: a, target: n }),
      ...
      function (require, module, exports) {
        ...
        function isTablet() {
          var e = globalsHelper.getWindow(),
            i = e.screen.width;
          return (
            e.orientation && e.screen.height < i && (i = e.screen.height),
        ...
        function debounce(e, i, n) {
          ...
          function a() {
            ...
            var l = function () {
              (t = null),
                n.leading
                  ? r > 1 && n.trailing && (e.apply(this, a), (r = 0))
                  : e.apply(this, a);
            }.bind(this);
            ...
            if (
              ...
              if (
                ...
                (r.version.string = s),
                  a &&
                    a.length > 0 &&
                    ((r.version.major = parseInt(a[0] || 0)),
              ...
              _createClass(e, [
                {
                  ...
                  value: function (e) {
                    (this.options = _objectSpread(
                      ...
                      this.options.destroyObservers &&
                        this.destroyObservers(this.options);
                  },
                },
                {
                  key: 'initialize',
                  value: function (e) {
                    if (
                      ...
                      errorHandler.exception ||
                        ((t = this.preAppMeasurementInit(t)),
                    ...
                    if (
                      ...
                      !errorHandler.exception &&
                        ...
                        this._setConfigurationProperty(
                          dlKeys.pageName,
                          this._getPageName(this.conf[dlKeys.track]),
                        ),
                        this._setConfigurationProperty(
                          dlKeys.productName,
                          this._getProductName(this.conf[dlKeys.track]),
                        ),
                        this._setConfigurationProperty(
                          dlKeys.locale,
                          this._getLocale(this.conf[dlKeys.track]),
                        ),
                      ...
                      this._setConfigurationProperty(
                        dlKeys.pageType,
                        this._getPageType(this.conf[dlKeys.pageName]),
                      );
                      ...
                      if (
                        ...
                        this._setConfigurationProperty(
                          dlKeys.countryBuckets,
                          constants.countryBuckets,
                        ),
                        this._setConfigurationProperty(
                          dlKeys.subdomains,
                        ...
                        this._setConfigurationProperty(
                          dlKeys.subdomainSupportedDomains,
                          constants.supportedSubdomains,
                        ),
                        this._setConfigurationProperty(
                          dlKeys.currencyCode,
                          'USD',
                        ...
                        this._setConfigurationProperty(
                          ...
                          constants.acAnalyticsVersion,
                        ),
                        this._setConfigurationProperty(
                          dlKeys.trackingDomain,
                          this.getTrackingDomain(),
                        ),
                        this._setConfigurationProperty(
                          dlKeys.cookieDomainPeriods,
                          this.setCookieDomainPeriods(),
                        ),
                        this._setConfigurationProperty(
                          dlKeys.cookieLifetime,
                          constants.cookieLifetime,
                        ),
                        this._setConfigurationProperty(
                          dlKeys.clickTimerCount,
                          0,
                        ),
                        this._setConfigurationProperty(
                          dlKeys.clickTimerLinkInteraction,
                          !1,
                        ),
                        this._setConfigurationProperty(
                          dlKeys.trackingServer,
                          this.getTrackingServer(),
                        ),
                        this._setConfigurationProperty(
                          dlKeys.trackingServerSecure,
                        ...
                        (this.formattedValues.countryCodeFilter =
                          formatter.countryCodeFilter(n)),
                          (this.formattedValues.legacyCountryCode =
                            formatter.legacyCountryCode(n)),
                          (this.formattedValues.pageName = formatter.pageName(
                            this.conf.pageName,
                            n,
                          )),
                          (this.formattedValues.channel = formatter.channel(
                            this.conf.channel,
                            n,
                          )),
                          (this.formattedValues.productName =
                            formatter.productName(this.conf.productName)),
                          (this.formattedValues.campaign = this.conf.campaign),
                          this._setConfigurationProperty(
                            dlKeys.linkInternalFiltersLocale,
                            this._getLinkInternalFiltersLocale(
                              this.formattedValues.countryCodeFilter,
                            ),
                          ),
                          this._setConfigurationProperty(
                            dlKeys.computedCampaign,
                            this.formattedValues.campaign,
                          ),
                          this._setConfigurationProperty(
                            dlKeys.computedProductName,
                            this.formattedValues.productName,
                          ),
                          this._setConfigurationProperty(
                            dlKeys.computedPageName,
                            this.formattedValues.pageName,
                          ),
                          this._setConfigurationProperty(
                            dlKeys.legacyCountryCode,
                            this.formattedValues.legacyCountryCode,
                          ),
                          this._setConfigurationProperty(
                            dlKeys.countryCodeFilter,
                            this.formattedValues.countryCodeFilter,
                          ),
                          ...
                          (this.conf[dlKeys.computedChannel] =
                            this._replaceTemplateVars(
                              this.formattedValues.channel,
                            )),
                          set(
                            [confKey, dlKeys.computedChannel],
                            this.conf.computedChannel,
                          ),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    (t.acAnalytics.version = e[dlKeys.acAnalyticsVersion]),
                      (t.acAnalytics.trackingDomain = t.Ia =
                        e[dlKeys.trackingDomain]),
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    this.options && this.options.referrer
                      ? (e = this.options.referrer)
                      : ((e = get([confKey, dlKeys.pageURL])),
                ...
                },
                {
                  ...
                  value: function (e) {
                    return (
                      ...
                      set(
                        [confKey, dlKeys.specialExitLinks],
                        generateSpecialExitLinks(),
                      ),
                      e
                    );
                  },
                      ...
                      errorHandler.exception ||
                        ...
                        errorHandler.exception ||
                          (e.submitMethod &&
                            ...
                            (this._setAppMeasurementProps(e),
                            submitMethods[e.submitMethod](
                              e,
                              get(confKey),
                              t,
    ...
    73: [
      function (require, module, exports) {
        ...
        module.exports = function (e) {
          e.ac_amt &&
            e.ac_amt._isEmpty &&
            e.ac_amt.eventListeners &&
            !e.ac_amt._isEmpty(e.ac_amt.eventListeners) &&
            e.ac_amt.destroy &&
            e.ac_amt.destroy(),
            (e.ac_amt = {
              addListener: function (e, t, s, n, i) {
                e &&
                  ...
                  (this.eventListeners[e] &&
                    this.removeListener(this.eventListeners[e]),
                  (this.eventListeners[e] = { node: t, type: s, listener: n }),
              ...
              removeListeners: function () {
                if (this.eventListeners) {
                  for (var e in this.eventListeners)
                    this.eventListeners.hasOwnProperty(e) &&
                      this.removeListener(
                        e,
                        this.eventListeners[e].node,
                        this.eventListeners[e].type,
                        this.eventListeners[e].listener,
                      );
                  this.eventListeners = {};
                }
              },
              removeListener: function (e, t, s, n) {
                e &&
                  ...
                  s &&
                  n &&
                  (t.removeEventListener(s, n), delete this.eventListeners[e]);
              },
              eventListeners: {},
              options: { reinitializeActivityMapCollection: !0 },
              _isEmpty: function (e) {
    ...
    74: [
      function (require, module, exports) {
        ...
        var prohref = ActivityMapCollection.prototype;
        (proto.init = function (e) {
          ...
          (this.AppMeasurement = e),
            this.AppMeasurement &&
              ...
              this.AppMeasurement.ac_amt.addListener
                ...
                : this.AppMeasurement.ac_amt.options &&
                  this.AppMeasurement.ac_amt.options
                    .reinitializeActivityMapCollection &&
                  this.createActivityMapCollection());
        }),
            ...
            (this.AppMeasurement = this.AppMeasurement || window.s),
              this.AppMeasurement &&
                ...
                (this.AppMeasurement.acAnalyticsActivityMapCollection =
                  this._assembleActivityMapCollection()));
          }),
          (proto._createLinkData = function (e) {
            var t = this._determineRegionName(
              e,
              this._globalRegionElements,
              this._regionSelectors,
            );
            return {
              element: e,
          ...
          (proto._addToActivityMapCollection = function (e) {
            var t,
              ...
              n = 0;
            if (
              (i = this.AppMeasurement.acAnalyticsActivityMapCollection.filter(
                function (t) {
              ...
              for (; a; )
                n++,
                  ...
                  (i =
                    this.AppMeasurement.acAnalyticsActivityMapCollection.filter(
                      function (e) {
                        return e.linkId === t;
                      },
          ...
          (proto._assembleActivityMapCollection = function () {
            this._globalRegionElements = _helpers.getGlobalElements(
              this._globalRegionSelectors,
            );
            for (
      ...
      function (require, module, exports) {
        ...
        module.exports = function (e) {
          e.ActivityMap.link = function (t, n) {
            var r;
            function i(t) {
              return (e.acAnalyticsActivityMapCollection || []).filter(
                function (e) {
            ...
            if (
              ...
              return (
                ActivityMapCollection.addElToCollection(t),
          ...
          isStorageAvailable(SESSION_STORAGE) &&
            ((e.getPercentPageViewed = function () {
              if (void 0 === s.linkType) {
                try {
                  s.ppv.previous = sessionStorage.getItem(
              ...
              if ((t || (t = ''), r)) {
                ...
                for (a = 0; a < f.length; a++)
                  (i = f[a]),
                    (o =
                      o ||
                      (1 == r ? i == e : i.toLowerCase() == e.toLowerCase()));
              }
              return o || (t = t ? t + n + e : e), t;
            }),
              ...
              _createClass(e, [
                {
                  ...
                  value: function (e) {
                    this.stages.forEach(function (i) {
                      i.phases &&
                        i.phases.forEach(function (i) {
                          i.steps &&
                            i.steps.forEach(function (i) {
                              i(e);
                            });
                        });
                    });
      ...
      function (require, module, exports) {
        ...
        function _storeData(e) {
          ...
          (t.events = JSON.parse(JSON.stringify(n.events))),
            ...
            beaconHelpers.isNotEmpty(t) &&
              mergeIntoDeferredBeacon(_sanitizeBeacon(t));
        }
        ...
        function _createDataObject() {
          var e = _getTimeSinceLoad(),
            n = { linkTrackVars: [], linkTrackEvents: [], events: [] };
          return (
            null !== e
        ...
        function contactRetail(a) {
          if ('e' === a.linkType && 'contactretail' === a.linkName) {
            ...
            a.ActivityMap &&
              ...
              a.linkObject &&
              (t = a.ActivityMap.region(a.linkObject));
            var e =
              get([
                dataLayerConfig.key,
          ...
          if (
            ...
            (e.linkName = ''.concat(a, ' - bag')),
              ...
              set(
                [
                  dataLayerConfig.key,
                  dataLayerConfig.keys.clickTimerLinkInteraction,
                ],
                !0,
              ),
      ...
      function (require, module, exports) {
        ...
        function track(e) {
          ...
          if (
            ...
            var a = trackingType();
            (r = filterBeaconsByType(r, a)).length &&
              (r = mergePassiveTrackerData(r)) &&
              prepareAppMeasurement(r);
          }
        }
        ...
        function setEventsData(e) {
          if (e.events) {
            var r = { events: parseEventCollectionString(e.events) },
              a = {};
            am.events
              ? (a.events = parseEventCollectionString(am.events))
              : (a.events = {});
          ...
          if (isTracking(r)) {
            ...
            if (isPageLoad(r)) {
              ...
              var i,
                n = get([
                  dataLayerConfig.key,
                  dataLayerConfig.keys.pageURLNoQueryString,
                ]);
              ...
              _createClass(e, [
                {
                  ...
                  value: function (e, r, t) {
                    ...
                    (this.exception = !0),
                      this.errors.push({ instance: e, method: r, message: a }),
                      _log(a),
                      trace();
                  },
                },
            ...
            _createClass(e, [
                ...
                value: function () {
                  if (0 !== this._queue.size()) {
                    ...
                    void 0 === e.async && (e.async = !0),
                      (!1 === e.async
                        ? this.sync(this.send.bind(this))
                        : this.async(this.send.bind(this))
                      ).then(
                        function () {
              ...
              },
              {
                ...
                value: function () {
                  !0 !== this.paused &&
                    this.canPause() &&
                    (this._queue.size() > 0 && this._queue.save(),
                    (this.paused = !0));
                },
              },
              {
        ...
        var dataLayerKeys = require('@apple/analytics-data-layer').KEYS,
          constants = {
            ...
            regexp: {
              ...
              storeUrlPattern: new RegExp(
                /^(https?:\/\/.*\.apple\.com)?(\/[a-z\-_0-9]*)?\/shop(\/.*)?$/i,
              ),
    ...
    122: [
      function (require, module, exports) {
        ...
        function destroy() {
          ...
          (e = _objectSpread(_objectSpread({}, defaultOptions), e))
            .clearRegions && regions.clearRegions(),
      ...
      function (require, module, exports) {
        ...
        function setSharedCookie(e) {
          ...
          (o = Object.assign({}, cookieOpts, o)),
            beaconHelpers.isNotEmpty(e) &&
              cookieJson.set(cookieName, sanitizeBeacon(e), o);
        }
    ...
    125: [
      function (require, module, exports) {
        ...
        function refresh(e) {
          ...
          for (
            var k = {}, y = document.querySelectorAll(r), b = 0;
            b < y.length;
            b++
          ) {
    ...
    127: [
      function (require, module, exports) {
        ...
        function removeListener(e) {
          eventListeners[e].node.removeEventListener(
            eventListeners[e].type,
            eventListeners[e].handler,
          ),
            delete eventListeners[e];
        }
        function removeListeners() {
          eventListeners &&
            (Object.keys(eventListeners).forEach(function (e) {
              removeListener(e);
            }),
            (eventListeners = {}));
        }
    ...
    131: [
      function (require, module, exports) {
        ...
        function specialExitLinks() {
          var e = get([
            dataLayerConfig.key,
            dataLayerConfig.keys.trackingDomain,
          ]);
          e &&
      ...
      function (require, module, exports) {
        ...
        function isFirstPageView() {
          return (
            ...
            ((window.sessionStorage.fpv = 0), !isAppleReferred())
          );
        }
    ...
    139: [
      function (require, module, exports) {
        ...
        function mergeData(e) {
          return (
            delete (e = e.reduce(function (e, r) {
              var t = mergeItem(e, r);
      ...
      function (require, module, exports) {
        ...
        function parseFromDataAttribute(e, t) {
          ...
          return (r = tokenReplacer.parseTokens(e)) && 0 !== r.length
            ? ((a = _getTokenValues(t, r)),
              (o = tokenReplacer.replace(e, a)),
              dataStringToObject(o))
            : dataStringToObject(e);
        }
      ...
      function (require, module, exports) {
        ...
        var PageObserver = require('./observers/Page.js'),
          ...
          defaults = {
            ...
            onPageDataLoadedOptions: { page: {}, click: {}, link: {} },
            compatibilityMode: !1,
          };
        function initialize(e) {
          e || (e = getSettings()),
            e && e.compatibilityMode && (e = setLegacySettings(e));
          var t = onPageDataLoaded(
              (e = e ? _objectSpread(_objectSpread({}, defaults), e) : defaults)
        ...
        function getSettings() {
          if (window.acAnalyticsSettings)
            return isNode(window.acAnalyticsSettings)
              ? getSettingsFromDOM()
        ...
        function setLegacySettings(e) {
          ...
          return (
            ...
            e.onPageDataLoadedOptions.page ||
              (e.onPageDataLoadedOptions.page = {}),
            e.onPageDataLoadedOptions.page.sourceData ||
              (e.onPageDataLoadedOptions.page.sourceData = {}),
            (e.onPageDataLoadedOptions.page.sourceData = _objectSpread(
              _objectSpread({}, a),
              e.onPageDataLoadedOptions.page.sourceData,
            )),
            e
          ...
          ClickAnalyticsObserver = (function (e) {
            ...
            function r() {
              ...
              return (
                ...
                ((e = t.call(this, n)).options = _objectSpread(
                  _objectSpread({}, defaultOptions),
                  n,
                )),
                ...
                (e.tracker = Tracker),
                (e.isEnabled = !1),
                (e._boundOnInteraction = e._onInteraction.bind(
      ...
      function (require, module, exports) {
        ...
        var EventEmitterMicro =
          ...
          defaultOptions = _objectSpread(
            _objectSpread({}, eeoDefaultOptions),
            {},
            {
              initListener: function () {
          ...
          ElementEngagementObserver = (function (e) {
            ...
            function r(e) {
              ...
              return (
                _classCallCheck(this, r),
                ((n = t.call(this, e)).options = Object.assign(
                  defaultOptions,
                  e,
                )),
                (n.tracker = Tracker),
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    (this.options.target = t),
                      (this.elementEngagementObserver = new EEO(
                        _objectSpread(
                          _objectSpread({}, this.options),
                          {},
                          { autoEnable: !0, track: this.track.bind(this) },
                        ),
                      ));
                  },
                },
              ...
              _createClass(e, [
                    ...
                    (this.interactionEvent = null),
                      e.interactionEvent &&
                        (this.interactionEvent =
                          this._createInteractionEvent(e));
                  },
                },
                {
                  key: '_getSlideId',
                ...
                },
                {
                  ...
                  value: function (e) {
                    if (
                      this.tracker &&
                      (!1 !== this.options.trackAutoRotate ||
                        (e.interactionEvent &&
                          (!e.interactionEvent.gallery ||
                            e.interactionEvent.gallery !== this.gallery)))
                    ) {
                      ...
                      'a' === i.nodeName.toLowerCase() && (t = i),
                        ...
                        t &&
                          ...
                          this.tracker.track({
                            ...
                            data: n,
                            options: JSON.parse(
                              JSON.stringify({ deferred: !0, beacon: {} }),
                            ),
                          }));
                    }
                  },
                ...
                },
                {
                  ...
                  value: function (e, t, r) {
                    this.tracker &&
                      this.tracker.track({
                        type: e,
                        data: { events: r.beacon.events.toString() },
                        options: JSON.parse(JSON.stringify(t)),
                      });
                  },
                },
    ...
    156: [
      function (require, module, exports) {
        ...
        ElementEngagement._elementInViewPastThreshold = function (e) {
          return (
            (e.engaged
              ? e.pixelsInView >= Math.min(this._windowHeight / 3, 325)
              : e.pixelsInView >= Math.min(this._windowHeight / 2.1, 450)) ||
            e.percentInView > e.inViewThreshold
          );
        };
        var defaultOptions = {
          ...
          trackedElementDefaults = { stopOnEngaged: !1, timeToEngage: 1e3 },
          debounceOptions = { leading: !0 },
              ...
              _createClass(n, [
                {
                  ...
                  value: function () {
                    errorHandler.exception ||
                      this.isEnabled ||
                      (this._bindMethods(),
                      this.options.customInitialization ||
                        (this._loadSections(), this.initializeTracking()));
                  },
                },
                {
                  ...
                  value: function (e) {
                    if (this.sections && 0 !== this.sections.length) {
                      ...
                      t &&
                        ...
                        Array.isArray(this.options.elements)
                          ? this.options.elements.push(e)
                          : (this.options.elements = [e]),
                        (t.tracking = !1),
                ...
                },
                {
                  ...
                  value: function () {
                    this.elementEngagement &&
                      ...
                      this.elementEngagement.elements.forEach(
                        function (e) {
                ...
                },
                {
                  ...
                  value: function () {
                    (this._onThresholdExit = this._onThresholdExit.bind(this)),
                      ...
                      (this.endSectionEngagement =
                        this.endSectionEngagement.bind(this)),
                      (this._getTrackedElement =
                        this._getTrackedElement.bind(this));
                  },
                },
                {
                  key: '_loadSections',
          ...
          VideoAnalyticsObserver = (function () {
            function e(t) {
              ...
              _classCallCheck(this, e),
                ...
                Array.isArray(this.options.mediaEvents) ||
                  errorHandler.log(
                    moduleName,
                    null,
              ...
              _createClass(e, [
                  ...
                  value: function () {
                    errorHandler.exception ||
                      (this.options.videoElement
                        ...
                        : this._isAcVideo() && this._setVideoElement(),
                  ...
                  value: function () {
                    ...
                    (this._milestoneTrackingTimeout = null),
                      ...
                      (this._milestonesSeeked = debounce(function () {
                        e._hadSeeked ||
                          (e._hadJustEnded && e._isAcVideo()
                            ? (e._hadJustEnded = !1)
                            : ((e._hadSeeked = !0),
                              e._refreshMilestones(),
                              e.videoElement &&
                                !e.videoElement.paused &&
                                ((e._milestoneTimeoutDuration = 2500),
                                e._checkForMilestone())));
                      }, 100)),
                      (this._milestonesSeekedCancel =
                        this._milestonesSeeked.cancel),
                ...
                },
                {
                  ...
                  value: function () {
                    var e = [];
                    return (
                      videoSegmentBoundries.forEach(function (t, i) {
                        i !== videoSegmentBoundries.length - 1 &&
                          e.push([t, videoSegmentBoundries[i + 1]]);
                      }),
                      e
                    );
                  },
                ...
                },
                {
                  ...
                  value: function () {
                    this._prepareForPlayFromStart(),
                      ...
                      !0 === this.options.trackCaptions &&
                        this.video.on(
                          this._events.texttrackshow,
                          this._onTextTrackShow,
                          this,
                        );
                  },
                },
                ...
                },
                {
                  ...
                  value: function () {
                    this._playBound ||
                      ...
                      IS_IE && this._isAcVideo() && this.ended
                        ? this.videoElement.addEventListener(
                            this._events.playing,
                            this._onPlayingFromStart,
                          )
                        : IS_IE
                        ? this.video.once(
                ...
                },
                {
                  ...
                  value: function (e) {
                    if (e.currentTime < 0.1) {
                      var t = !0;
                      this.videoElement &&
                        void 0 !== _typeof(this.videoElement.paused) &&
                        (t = this.videoElement.paused),
                        this.playCount > 0 &&
                          this._started &&
                          t &&
                          ((this._started = !1),
                ...
                },
                {
                  ...
                  value: function (e) {
                    ...
                    !t.paused &&
                      !t.ended &&
                      t.currentTime > 0 &&
                      ((i.ttShowCount = this.ttShowCount),
                      this.track(i),
                      (this.ttShowCount += 1));
                  },
                },
                  ...
                  value: function () {
                    (this._milestonesSeeking =
                      ...
                      (this._milestonesSeeked =
                        this._milestonesSeeked.bind(this)),
                      (this._milestonesPlay = this._milestonesPlay.bind(this)),
                      (this._milestonesPause =
                        this._milestonesPause.bind(this));
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    this._milestoneTrackingTimeout &&
                      clearTimeout(this._milestoneTrackingTimeout),
                      (this._milestoneTrackingTimeout = setTimeout(
                        function () {
                        ...
                        this._milestoneTimeoutDuration,
                      ));
                  },
                },
                {
                  ...
                  value: function () {
                    ...
                    if (
                      !(
                        ...
                        0 === this.videoElement.currentTime ||
                        this.videoElement.readyState < 3 ||
                        0 === this.videoElement.duration ||
                        this.videoElement.duration === 1 / 0 ||
                        isNaN(this.videoElement.duration)
                      ) &&
                      this._activeVideoMilestones[0] &&
                      !((e =
                      ...
                      var t,
                        i = this._activeVideoMilestones.filter(function (i, s) {
                          if (e >= i[0] && e < i[1]) return (t = s), !0;
                        });
                      return i && i[0] ? { name: i[0][0], index: t } : void 0;
                    }
                  },
                },
                {
                ...
                },
                {
                  ...
                  value: function () {
                    this._hadSeeked
                      ? (this._activeVideoMilestones =
                          this._allVideoMilestone.slice(0))
                      : (this._activeVideoMilestones =
                          this._allVideoMilestone.slice(1));
                  },
                },
                {
                  key: 'addListener',
                  ...
                  value: function (e) {
                    ...
                    return (
                      ...
                      this.videoElement &&
                        ...
                        (i.src = null),
                        isNaN(this.videoElement.duration) ||
                          (i.duration = this.videoElement.duration),
                        isNaN(this.videoElement.currentTime) ||
                          (i.currentTime = this.videoElement.currentTime),
                        void 0 !== this.videoElement.src &&
                          (i.src = this._getUniqueVideoId(
                      ...
                      this._hadSeeked &&
                        ...
                        (i.currentTime =
                          i.currentTime -
                          this._milestoneTimeoutDuration /
                            (this._milestoneTimeoutDuration / 2)),
                      i
                    );
                  },
                },
                ...
                },
                {
                  ...
                  value: function (e, t) {
                    return (
                      (!e.length && !t.length) ||
                      e[0] > t[0] ||
                      (parseInt(e[0]) === parseInt(t[0])
                        ? this._isVersionGreaterOrEqual(e.slice(1), t.slice(1))
                        : !(e[0] < t[0]) && void 0)
                    );
                  },
                },
                ...
                },
                {
                  ...
                  value: function (e) {
                    this.observers[e.observerType] &&
                      ...
                      this.observers[e.observerType].length ||
                        delete this.observers[e.observerType]);
                  },
                },
              ]),
              e
        ...
        function track(e, t) {
          if (
            ...
            (t.priority = t.priority || 50),
              ...
              (e.options = {}),
              t.overwriteAppMeasurementValues &&
                (e.options.overwriteAppMeasurementValues = !0),
              !1 === t.overwriteAppMeasurementEvents &&
            ...
            r
              ? ((r = templateVarHelper.translate(r, templateVarHelper.set())),
    ...
    161: [
      function (require, module, exports) {
        ...
        function track(t) {
          ...
          return (
            (t.beacon.title = e.formattedTitle),
        ...
        function generateSourceData(t) {
          ...
          return (
            ...
            (r.regionAncestry = regions.getRegionAncestryByElement(
              t.data.targetEl,
            )),
      ...
      function (require, module, exports) {
            ...
            var n = e.options,
              r = setInterval(function () {
                window.performance.timing.loadEventEnd &&
                  (performanceWrite(window.performance, n),
        ...
        function performanceWrite(e) {
          ...
          r.push(performanceCheck(n.fetchStart, n.navigationStart)),
            ...
            r.push(
              performanceCheck(n.domContentLoadedEventEnd, n.domInteractive),
            ),
              ...
              _createClass(t, [
                ...
                },
                {
                  ...
                  value: function () {
                    ...
                    this._isJSONable(e)
                      ? (t = dataStringToObject(e))
                      : this._isSingleValue(e) && (t.name = e),
                    i &&
                      this._isJSONable(i) &&
      ...
      function (require, module, exports) {
        ...
        function getAllRegions() {
          ...
          function i(e) {
            for (
              var o;
              domNodes.isNodeType(n[t + 1], domNodes.NODE_TYPES.ELEMENT) &&
              e.element.contains(n[t + 1]);
    ...
    175: [
      function (require, module, exports) {
        ...
        function track(e) {
          ...
          return a
            ? (merge({ target: e.beacon, source: getBeginBeacon(a) }),
        ...
        function getSearchObj(e) {
          if (!(e && e.type && e.event && e.event.dynamicEventBinderTarget))
            return null;
          if (!config.trackEvents.includes(e.type)) return null;
    ...
    176: [
      function (require, module, exports) {
        ...
        function track(e) {
          ...
          return r
            ? ((e.options.deferred = !0),
              (e.options.silent = !0),
              merge({ target: e.beacon, source: getPerformBeacon(r) }),
              e)
            : null;
        }
        function getSearchObj(e) {
          ...
          return (
            [submitForm, clickLink].reduce(function (e, r) {
              return e || r({ el: t });
            }, null) || null
          );
        }
        ...
        function getInputValue(e) {
          ...
          return get(pageTypeKey) === config.errorPage.pageType
            ? (null ===
                (r = e.querySelector(config.keywordSelectors.errorPage)) ||
              void 0 === r
                ? void 0
                : r.value) || null
            : (e.matches(config.globalNav) &&
                (null ===
                  (a = e.querySelector(config.keywordSelectors.globalNav)) ||
                void 0 === a
                  ? void 0
                  : a.value)) ||
                null;
    ...
    179: [
      function (require, module, exports) {
        ...
        function track(e) {
          var t = e.data;
          (t.eventType = eventTypes[t.eventType]
            ? eventTypes[t.eventType](e)
            : t.eventType),
            t.event &&
          ...
          var n =
            ...
            r = _setTitle(
              t,
              n,
              t.eventType && eventTypeMap[t.eventType]
                ? eventTypeMap[t.eventType]
                : t.eventType,
            ),
            a = {};
