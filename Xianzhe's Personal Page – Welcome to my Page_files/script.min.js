jQuery(document).ready(function (r) {
  ...
  function e(t) {
    var i = !1;
    (t.is(r.material.options.checkboxElements) ||
      t.is(r.material.options.radioElements)) &&
      (i = !0),
          ...
          .each(function () {
            ...
            if (
              (0 !== o.length ||
                "hidden" === a.attr("type") ||
                a.attr("hidden") ||
                a.parents(".pirate_forms").length ||
                (a.wrap('<div class="form-group"></div>'),
                (o = a.closest(".form-group"))),
              0 === o.length &&
                "hidden" !== a.attr("type") &&
                !a.attr("hidden") &&
            ...
            a.attr("data-hint") &&
              (a.after('<p class="help-block">' + a.attr("data-hint") + "</p>"),
              a.removeAttr("data-hint"));
            if (
              (r.each(
              ...
              i && (n = 'for="' + i + '"'),
                ...
                a.after(
                  "<label " + n + 'class="control-label">' + e + "</label>"
                );
            }
            (null !== a.val() && "undefined" !== a.val() && "" !== a.val()) ||
              o.addClass("is-empty"),
              0 < o.find("input[type=file]").length &&
      ...
      (l.hestia = {
          ...
          l(window).on("scroll", function () {
            ...
            (a =
              0 < e.length
                ...
                : 0) <= t &&
              0 === o &&
              (l(".hestia-scroll-to-top").addClass("hestia-fade"), (o = 1)),
              t <= a &&
                1 === o &&
        ...
        setControlLabel: function () {
          ...
          if (void 0 !== a) {
            ...
            "" === l(o).attr("value")
              ? l(a).addClass("label-floating is-empty")
              : l(a).addClass("label-floating"),
            ...
            if (l("body").hasClass("home") && 751 <= l(window).width()) {
              ...
              l("#carousel-hestia-generic, section").each(function () {
                var t = "#" + l(this).attr("id"),
                  ...
                  i = e + a - r;
                if (
                  n + l.utilitiesFunctions.verifyNavHeight() >= o &&
                  n + l.utilitiesFunctions.verifyNavHeight() <= i
                )
                  return (
                    (s = "yes"),
