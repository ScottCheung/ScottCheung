  ...
  (function (t) {
    ...
    function i(i) {
      return this.each(function () {
        ...
        o || s.data("bs.carousel", (o = new e(this, n))),
          "number" == typeof i
            ? o.to(i)
            : a
            ? o[a]()
            : n.interval && o.pause().cycle();
      });
    }
    (e.VERSION = "3.3.7"),
              ...
              ? (n.addClass(i),
                ...
                o
                  .one("bsTransitionEnd", function () {
                    n.removeClass([i, r].join(" ")).addClass("active"),
  ...
  (function (t) {
    ...
    function i(i, s) {
      return this.each(function () {
        ...
        n || o.data("bs.modal", (n = new e(this, a))),
          "string" == typeof i ? n[i](s) : a.show && n.show(s);
      });
    }
    (e.VERSION = "3.3.7"),
          ...
          this.isShown ||
            ...
            this.backdrop(function () {
              ...
              s.$element.parent().length || s.$element.appendTo(s.$body),
                ...
                s.enforceFocus();
              var n = t.Event("shown.bs.modal", { relatedTarget: i });
              o
                ? s.$dialog
                    .one("bsTransitionEnd", function () {
      ...
      t(document).on(
        ...
        function (e) {
          var s = t(this),
            ...
            a = n.data("bs.modal")
              ? "toggle"
              : t.extend({ remote: !/#/.test(o) && o }, n.data(), s.data());
    ...
    (e.VERSION = "3.3.7"),
      ...
      (e.prototype.getViewportAdjustedDelta = function (t, e, i, s) {
        ...
        if (/right|left/.test(t)) {
          ...
          h < a.left
            ? (o.left = a.left - h)
            : d > a.right && (o.left = a.left + a.width - d);
        }
        return o;
      }),
    ...
    (t.fn.tooltip = function (i) {
      return this.each(function () {
        ...
        (!o && /destroy|hide/.test(i)) ||
          (o || s.data("bs.tooltip", (o = new e(this, n))),
          "string" == typeof i && o[i]());
      });
    }),
    ...
    function s(i) {
      return this.each(function () {
        var s = t(this),
          ...
          n = t.extend({}, e.DEFAULTS, s.data(), "object" == typeof i && i);
        !o && n.toggle && /show|hide/.test(i) && (n.toggle = !1),
          o || s.data("bs.collapse", (o = new e(this, n))),
          "string" == typeof i && o[i]();
      });
    }
    (e.VERSION = "3.3.7"),
      ...
      (e.prototype.show = function () {
        if (!this.transitioning && !this.$element.hasClass("in")) {
          ...
          if (
            !(o && o.length && (i = o.data("bs.collapse")) && i.transitioning)
          ) {
