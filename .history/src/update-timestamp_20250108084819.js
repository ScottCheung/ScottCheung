...
(async () => {
  ...
  const newLogEntry = {
    ...
    // 自定义
    header: [
      "Happy New Year. This time I've made some changes to the content and details of the MBTI personality test, and updated the UI. Hope you like it.",
      '新年快乐！这次我对 MBTI 性格的测试内容和细节进行了一些更改，并更新了 UI。希望你们喜欢。',
    ],
    new: [
      [
        "I've made some changes to the content and details of the MBTI personality test.",
        'Adjust partial UI and Animations in Home and CV page.',
      ],
      [' MBTI 性格的测试内容和细节进行了一些更改'],
    ],
    fix: [
      [
