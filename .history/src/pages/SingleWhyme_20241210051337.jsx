      ...
      >
        ...
        >
          <motion.div
            ...
            whileInView={{ opacity: 1, y: '0px', scale: 1 }}
            viewport={{ once: true }}
            className={`pb-[35vw] lg:pb-[30vw] relative flex flex-col  break-words bg-yellow-50 w-full shadow-xl rounded-[28px] -mt-[80px] animate__animated animate__fadeInUp`}
          >
            <div
