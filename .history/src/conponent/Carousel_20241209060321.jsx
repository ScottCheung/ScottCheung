  ...
  return (
    <motion.div
      ...
      style={{
        ...
        maskImage:
          'linear-gradient(to bottom, rgba(256, 256, 256, 1) 0%, rgba(0, 0, 0, 1) 5%, rgba(0, 0, 0, 1) 95%, rgba(0, 0, 0, 1) 100%)',
        WebkitMaskImage:
          'linear-gradient(to bottom, rgba(0, 0, 0, 1) 0%, rgba(0, 0, 0, 1) 5%, rgba(0, 0, 0, 1) 95%, rgba(0, 0, 0, 1) 100%)',
      }}
            ...
            >
              ...
              >
                <motion.svg
                  ...
                  className={`w-[35px] h-[35px] fill-white ${isPaused ? 'animate__rotateIn' : 'animate__rotateIn'} animate__animated transition-all ring-0 outline-none`}
                  viewBox='0 0 48 48'
                >
                  <motion.path
