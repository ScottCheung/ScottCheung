          ...
          <div className='pb-[70%] flex-grow'>
            ...
            >
              {personality.feature[lang].map((per, index) => (
                <motion.div key={index} layout className='group'>
                  <motion.div
                    layout
                    className={`${
                  ...
                  >
                    <motion.div
                      onClick={() => setCurrent(!per.name)}
                      className='text-[23px] font-[500] flex items-baseline'
                    >
                      <div> {per.right}</div>
                      <motion.div className=' ml-[10px] hover:cursor-pointer text-[15px] flex items-baseline '>
                  ...
                  <motion.div
                    layout
                    className='w-full h-[15px] mb-4 rounded-full bg-white/20 darrk:bg-gray-700'
                  >
                    <motion.div
                      key={index}
                      variants={{
                  ...
                  {current === per.name && (
                    <motion.div
                      ...
                      initial={{ height: 0 }}
                      animate={{ height: '100%' }}
                      className='bg-white/5 over-hidden p-[20px]  my-[20px] rounded-[14px]'
                    >
                      <motion.div
                        className={`${
                          per.color1 + ' ' + per.color2
