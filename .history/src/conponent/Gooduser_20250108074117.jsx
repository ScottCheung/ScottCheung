  ...
  const Gooduser = (
    ...
    <motion.div className='col-span-12 md:col-span-6 lg:col-span-8 group'>
      ...
      >
        ...
        >
          <div className='absolute z-0 w-full h-full  bg-gradient-to-br via-[30%] to-[125%]  transition-all duration-1000 from-blue-900 via-green-900 to-black  group-hover:opacity-50'></div>
          <motion.div
