  ...
  const Highquality = (
    <motion.div className='flex h-full w-full min-h-[1000px] col-span-12 relative md:col-span-6 lg:col-span-4'>
      ...
      <motion.div
        ...
        className='rounded-[28px] p-[20px]  lg:p-[40px] flex-1 flex-col-reverse lg:flex-col'
      >
        <motion.div
          ...
          className=' flex w-full  -ml-[130px] lg:h-[200px] h-full '
          style={{
        ...
        ></motion.div>
        <motion.div className=' gap-y-[60px] flex flex-col h-full'>
