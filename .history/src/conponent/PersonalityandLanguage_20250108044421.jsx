          ...
          <div className='pb-[70%] flex-grow'>
            ...
            >
              {personality.feature[lang].map((per, index) => (
                <motion.div layout className='transition-all group'>
                  <motion.div
                    key={index}
                    className={`${
                  ...
                  >
                    <motion.div className='text-[18px] font-[500] flex items-baseline'>
                      <div> {per.name}</div>
                      <div className='ml-[15px] text-[13px]'>{per.right}</div>
                      <div className='ml-[15px] text-[13px] flex opacity-50'>
                        {per.left}
                      </div>
                    </motion.div>
                  ...
                  <motion.div
                    ...
                    className={`${
                      per.color1 + ' ' + per.color2
                    } group-hover:flex hidden justify-between bg-gradient-to-r text-transparent bg-clip-text pb-[10px]`}
                  >
                    <motion.div className='text-[15px] font-[600]'>
                      {per.left}
                    </motion.div>
