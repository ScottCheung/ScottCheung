  ...
  const content = [
    {
      ...
      text:
        lang == 0 ?
          SelectText(
            ' Whether it’s [coding efficiently], [crafting visually stunning designs], or [enhancing user experiences], I strive for perfection in every detail. Excellence isn’t a goal; it’s my habit.',
            'yellow-300',
            '\t ',
          )
        : SelectText(
            '无论是[高效编程]、[设计美观界面]还是[优化用户体验]，我都在每一个细节上追求极致。卓越不是目标，而是习惯。',
            'yellow-300',
          ),
    },
    {
