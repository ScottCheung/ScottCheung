              ...
              {personality.feature[lang].map((per, index) => (
                <motion.div layout className='group '>
                  ...
                  <motion.div
                    ...
                    className={`${
                      per.color1 + ' ' + per.color2
                    } group-hover:flex flex-col hidden bg-gradient-to-r bg-black/70 p-[20px] rounded-card text-transparent bg-clip-text pb-[10px]`}
                  >
                    <div className='flex justify-between '>
                      ...
                      >
                        {per.left} <N className='' n={100 - per.label} d={3} />{' '}
                        %
                      </motion.div>
