    ...
    <motion.div className='col-span-12 md:col-span-6 lg:col-span-8'>
      <motion.div
        ...
        style={{
          ...
          backgroundSize: open ? '100% 200%' : '100% 100%',
          backgroundRepeat: 'no-repeat',
          backgroundPosition: 'bottom center ',
        }}
        className='h-full rounded-[28px]  overflow-hidden '
      >
        <motion.div
          layout
          transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }}
        ...
        >
          <div className='absolute z-0 w-full h-full  bg-gradient-to-br to-[30%] hover:to-[25%] transition-all duration-1000 from-blue-900 to-black opacity-80'></div>
          <motion.div
