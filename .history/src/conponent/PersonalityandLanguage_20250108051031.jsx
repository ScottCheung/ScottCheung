        ...
        >
          <div className='pb-[70%] flex-grow'>
            <motion.div
              ...
              className='flex flex-wrap items-center justify-between overflow-hidden mb-[20px]'
            >
              <h3
                style={{
                  lineHeight: 1.19048,
              ...
              {personality.feature[lang].map((per, index) => (
                <motion.div layout className='group '>
                  <motion.div
                    ...
                    } flex justify-between group-hover:cursor-pointer bg-gradient-to-r text-transparent bg-clip-text pb-[10px]`}
                  >
                    <motion.div className='text-[18px] font-[500] flex items-baseline'>
                      <div> {per.name}</div>
                      <motion.div
                        layoutId='left'
                        className='ml-[15px] text-[13px] group-hover:hidden'
                      >
                        {per.right}
                      </motion.div>
                    </motion.div>
                  ...
                  <motion.div
                    ...
                    className='bg-black p-[20px] hidden group-hover:flex'
                  >
                    <motion.div
                      className={`${
                        per.color1 + ' ' + per.color2
                      }  flex-col flex bg-gradient-to-r  rounded-card text-transparent bg-clip-text pb-[10px]`}
                    >
                      <div className='flex justify-start gap-[20px] items-baseline'>
                        <motion.div className='flex text-[15px] font-[600] '>
                          {per.right}
                          <N className='mx-[10px]' n={per.label} d={1} /> %
                        </motion.div>
                        <i className='fi fi-rr-plus flex text-[30px]'></i>
                        <motion.div
                          layoutId='left'
                          className='flex text-[15px] font-[600]]'
                        >
                          {per.left}{' '}
                          <N className='mx-[10px]' n={100 - per.label} d={1} />{' '}
                          %
                        </motion.div>
                      </div>
                      <motion.div className='flex text-[15px] my-[20px] font-[600]'>
                        {per.des}
                      </motion.div>
                    </motion.div>
                  </motion.div>
          ...
          <motion.div
            layout
            className='absolute bottom-0 left-0 right-0 h-[70%] mb-[20px] md:mb-[40px]'
            style={{
              backgroundImage: `url(https://www.16personalities.com/static/images/types/headers/campaigner-mobile.svg)`,
