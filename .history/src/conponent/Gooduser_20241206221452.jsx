...
function Gooduser() {
  ...
  const Gooduser = (
    ...
    <motion.div className='col-span-12 md:col-span-6 lg:col-span-8'>
      <motion.div className='h-full relative  rounded-[28px] overflow-hidden bg-gradient-to-br to-[30%] hover:to-[25%] transition-all from-blue-900 to-black '>
        <motion.div
          className='absolute bottom-0 z-10 bg-cover'
          layout
          style={{
