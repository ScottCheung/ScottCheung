...
function Gooduser() {
  ...
  const Gooduser = (
    ...
    <motion.div className='col-span-12 md:col-span-6 lg:col-span-8'>
      <motion.div className='h-full  overflow-hidden bg-gradient-to-br to-[30%] hover:to-[25%] transition-all from-blue-900 to-black '>
        <motion.div
          layout
          className='w-full h-full bg-cover overflow-hidden rounded-[28px]'
          style={{
        ...
        >
          ...
          <motion.div
            ...
            className='p-[20px] lg:p-[40px] z-10 '
          >
          ...
          <motion.div
            ...
            className='mb-[30px] rounded-[28px] z-10'
          >
            <motion.div
