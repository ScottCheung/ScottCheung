  ...
  const Gooduser = (
    ...
    <motion.div className='col-span-12 md:col-span-6 lg:col-span-8'>
      <motion.div className=' rounded-[28px] overflow-hidden bg-gradient-to-br to-[30%] hover:to-[25%] transition-all from-blue-900 to-black '>
        <motion.div
          className='pb-[30%] tile-content bg-cover  z-0 '
          style={{
            backgroundImage: `url(https://cia.hyperos.mi.com/hyperos2-homepage/opening_pc_temp.png?imageMogr2/thumbnail/2900x/quality/80/format/webp)`,
