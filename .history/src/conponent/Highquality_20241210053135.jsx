  ...
  const content = [
    ...
    },
    {
      ...
      text:
        lang == 0 ?
          SelectText(
            'I am driven by challenges and see every [obstacle] as an opportunity. I tackle difficulties head-on and deliver results that exceed expectations.',
            'yellow-300',
            '\t ',
          )
        : SelectText(
            '我以挑战为动力，把每个[障碍]都视为机会。我迎难而上，总能交付超出预期的成果。',
            'yellow-300',
          ),
    },
    {
      ...
      text:
        ...
        : SelectText(
            '成果对我而言至关重要。我确保每个项目都围绕目标展开，并取得可衡量的成功。我不仅关注任务的完成，更在意创造有[影响力]的结果。',
            'yellow-300',
          ),
    },
    {
