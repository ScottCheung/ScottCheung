        ...
        >
          <div className='flex-grow mb-[250px]'>
            <motion.div
              ...
              layout='position'
              className='flex  p-[20px] lg:p-[40px]  flex-wrap items-center justify-between overflow-hidden mb-[40px]'
            >
              <h3
                style={{
                  lineHeight: 1.19048,
            ...
            >
              {personality.feature[lang].map((per, index) => (
                <motion.div
                  ...
                  key={index + per.name}
                  className='flex flex-col  px-[20px] lg:px-[40px] py-8  hover:cursor-pointer hover:bg-black/20 transition-colors'
                >
                  <motion.div
                    className={`${
