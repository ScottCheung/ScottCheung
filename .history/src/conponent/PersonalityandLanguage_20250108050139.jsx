                  ...
                  >
                    ...
                    >
                      <div className='flex justify-between gap-[20px]'>
                        <motion.div className='flex text-[15px] font-[600] gap-[20px]'>
                          {per.right} <N className='' n={per.label} d={3} /> %
                        </motion.div>
                        +
                        <motion.div
                          layoutId='left'
                        ...
                        >
                          {per.left}{' '}
                          <N className='' n={100 - per.label} d={3} /> %
                        </motion.div>
                      </div>
                      <motion.div className='flex text-[15px] my-[20px] font-[600] gap-[20px]'>
                        {per.des}
                      </motion.div>
                    </motion.div>
                  </motion.div>
