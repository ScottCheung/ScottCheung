              ...
              {personality.feature[lang].map((per, index) => (
                ...
                >
                  <motion.div
                    ...
                    } flex justify-between  bg-gradient-to-br text-transparent bg-clip-text pb-[10px]`}
                  >
                  ...
                  {current === per.name && (
                    <motion.div
                      ...
                      transition={{ duration: 1, ease: [0.22, 1, 0.36, 1] }}
                      className='bg-white/5 transition-all over-hidden p-[20px]  stagerY my-[20px] rounded-[14px]'
                    >
                      <motion.div
                        className={`${
                          per.color1 + ' ' + per.color2
                        }  flex-col flex bg-gradient-to-br text-transparent bg-clip-text pb-[10px] gap-y-[20px]`}
                      >
                        <motion.div className='text-[20px] font-black flex stagerY'>
                          {per.name}
                        </motion.div>
                        <motion.div className='flex justify-start  text-[15px] gap-[10px] items-baseline stagerY'>
                        ...
                        <motion.div className='flex text-[15px]  font-[600] stagerY'>
                          {per.defi}
                        </motion.div>
                        <motion.div className='flex text-[15px]  font-[600] stagerY'>
                          {per.des}
