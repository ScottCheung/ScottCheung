                    ...
                    >
                      ...
                      >
                        <motion.div
                          ...
                          className='text-[20px] font-black flex welcomeanimation'
                        >
                          {per.name}
                        </motion.div>
                        <motion.div
                          style={{ animationDelay: '0.2s' }}
                          className='flex justify-start  text-[15px] gap-[10px] items-baseline welcomeanimation'
                        >
                        ...
                        <motion.div
                          ...
                          className='flex text-[15px]  font-[600] welcomeanimation'
                        >
                          {per.defi}
                        </motion.div>
                        <motion.div
