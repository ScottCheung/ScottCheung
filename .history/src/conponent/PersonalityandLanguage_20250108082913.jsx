    ...
    <motion.div className=' col-span-12 md:col-span-6 lg:col-span-4 min-h-[930px]'>
      <motion.div className='flex flex-col h-full gap-[14px] lg:gap-[28px] relative'>
        ...
        <motion.div
          ...
          className='flex-1 rounded-[28px] transition-all relative overflow-hidden lg:overflow-visible'
        >
            ...
            >
              {personality.feature[lang].map((per, index) => (
                ...
                >
                  ...
                  >
                    <motion.div className='text-[23px] font-[500]  flex flex-col items-start '>
                      <div> {per.right}</div>

                      <motion.div className=' text-[15px] flex items-baseline'>
