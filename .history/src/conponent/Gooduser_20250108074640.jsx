  ...
  const Gooduser = (
    ...
    <motion.div className='col-span-12 md:col-span-6 lg:col-span-8 group'>
      ...
      >
        ...
        >
          <div className='absolute z-0 w-full h-full  bg-gradient-to-br via-[30%]  to-[120%]  transition-all duration-1000 from-blue-900 via-black to-purple-950  group-hover:opacity-30'></div>
          <motion.div
