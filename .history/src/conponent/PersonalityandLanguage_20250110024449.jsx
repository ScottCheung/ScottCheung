                ...
                >
                  ...
                  {current === per.name && (
                    ...
                    >
                      ...
                      >
                        <motion.div className='text-[20px] font-black flex stagerX'>
                          {per.name}
                        </motion.div>
                        <motion.div className='flex justify-start  text-[15px] gap-[10px] items-baseline stagerX'>
                        ...
                        <motion.div className='flex text-[15px]  font-[600] stagerX'>
                          {per.defi}
                        </motion.div>
                        <motion.div className='flex text-[15px]  font-[600] stagerX'>
                          {per.des}
