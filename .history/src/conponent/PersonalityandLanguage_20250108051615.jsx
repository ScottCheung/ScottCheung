        ...
        >
          <div className='pb-[70%] flex-grow'>
            <motion.div
              ...
              className='flex flex-wrap items-center justify-between overflow-hidden mb-[40px]'
            >
              <h3
                style={{
                  lineHeight: 1.19048,
              ...
              {personality.feature[lang].map((per, index) => (
                <motion.div layout className='group '>
                  ...
                  <motion.div
                    ...
                    initial={{ height: 0 }}
                    animate={{ height: 'auto' }}
                    className='bg-black/20 over p-[20px] hidden group-hover:flex my-[20px] rounded-[14px]'
                  >
                    <motion.div
                      className={`${
                        per.color1 + ' ' + per.color2
                      }  flex-col flex bg-gradient-to-r text-[20px] text-transparent bg-clip-text pb-[10px]`}
                    >
                      <div className='flex justify-start gap-[20px] items-baseline'>
                        ...
                        <i className='flex fi fi-sr-plus text-[10px]'></i>
                        <motion.div
                          layoutId='left'
