  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className='absolute bottom-0 left-0 text-[25px] bg-gradient-to-b from-white/0 via-[5px] via-white/90 to-white right-0 flex items-center justify-between lg:p-[40px] p-[28px]'>
