  ...
  const content = [
    ...
    },
    {
      ...
      text:
        lang == 0 ?
          SelectText(
            'I view every [challenge] as a chance to grow. I approach issues methodically to find [effective solutions].',
            'yellow-500',
            '\t ',
          )
        : SelectText(
            '我将每个[挑战]视为成长的机会。我以条理清晰的方式解决问题，找到[高效方案]。',
            'yellow-500',
          ),
    },
    {
    ...
    },
    {
      ...
      text:
        lang == 0 ?
          SelectText(
            'I believe in [collaboration] and value [team diversity]. Together, we achieve better [results].',
            'yellow-500',
            '\t ',
          )
        : SelectText(
            '我相信[协作]，重视[团队多样性]。携手合作，我们能取得更好的[成果]。',
            'yellow-500',
          ),
    },
  ];
    ...
    <motion.div className='flex h-full w-full min-h-[600px] col-span-12 relative md:col-span-6 lg:col-span-4'>
      ...
      >
        <motion.div
          ...
          className='p-[20px] lg:p-[40px] gap-y-[40px] flex flex-col h-full'
        >
