              ...
              >
                ...
                >
                  <motion.div className=''>
                    <motion.div
                      className={` ${hideTittle ? 'bg-gray-50' : 'bg-white/80'}  hover:scale-[1.01] transition-all duration-300 p-[14px] lg:p-[35px] rounded-[14px] lg:rounded-[28px] relative flex-shrink-0 overflow-hidden w-auto h-auto ${hideTittle ? 'lg:w-[250px]' : 'lg:w-[350px] '}  md:h-auto `}
                    >
                      <motion.div
                        style={{
                          ...
                          : {}),
                          filter:
                            'drop-shadow(0px 20px 26px rgba(0, 0, 0, 0.3))',
                        }}
