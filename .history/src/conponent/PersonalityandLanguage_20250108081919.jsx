            ...
            >
              {personality.feature[lang].map((per, index) => (
                ...
                >
                  ...
                  >
                    <motion.div className='text-[23px] font-[500]  flex flex-col items-baseline '>
                      <div> {per.right}</div>
                    ...
                    <motion.div className='flex flex-col text-[20px]  font-[600]'>
                      <div className='flex'>
                      ...
                      <Toggle
                        text={' '}
                        onlyicon={true}
                        textStyle='text-[1px] font-[600] text-white'
