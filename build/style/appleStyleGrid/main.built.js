...
, function(e, t, i) {
    "use strict";
    var s, n = i(6).EventEmitterMicro, r = i(67), o = i(124);
    function a(e) {
        e = e || {},
        n.call(this),
        this.id = o.getNewID(),
...
, function(e, t, i) {
    ...
    class g {
        ...
        parseOptions(e) {
            ...
            a.hasOwnProperty(e.easeFunction) || (e.easeFunction.includes("bezier") ? this.easeFunction = l.fromCSSString(e.easeFunction) : e.easeFunction.includes("spring") ? this.easeFunction = h.fromCSSString(e.easeFunction) : console.error("Keyframe parseOptions cannot find 'easeFunction' named '" + e.easeFunction + "'"));
            for (let t in e) {
                    ...
                    void 0 === this.controller.tweenProps[t] || !this.controller._ownerIsElement) {
                        ...
                        if (!h && this.controller._ownerIsElement)
                            if (a || p.includes(t)) {
                                ...
                                _.includes(t) && (h = new n(o,s.KeyframeDefaults.epsilon,this.snapAtCreation,t,e.round,l),
                                this.controller.domAttributes.push(h));
                        h || (h = new n(o,s.KeyframeDefaults.epsilon,this.snapAtCreation,t,e.round,l)),
...
, function(e, t, i) {
    ...
    t.default = t.FEATURE_ENHANCED = t.EVT_UNENHANCE_FEATURE = t.EVT_UNENHANCE = void 0;
    var n = s(i(3))
      , r = s(i(8))
      , o = i(145)
      , a = i(13)
    ...
    class y extends r.default {
        ...
        async _unenhanceFeature(e) {
            this.isEnhanced(e) && (this.logger.log("PageXpController: unenhance: ", e),
            this.isEnhanced() && (await h.removeFeatureDetectClass(f),
            this.anim.trigger(m),
...
, function(e, t, i) {
    ...
    e.exports = function(e) {
        const t = {}
          , i = s(n);
        return t.browser = o(n.browser, i.browser, e),
        t.os = o(n.os, i.os, e),
        t
    }
}
    ...
    class o extends s {
        ...
        parseOptions(e) {
            ...
            void 0 !== e.cssClass)
                ...
                if (this._triggerType = o.TRIGGER_TYPE_STYLE_PROPERTY,
                this.style = e.style,
...
, function(e, t, i) {
    ...
    const s = i(34)
      ...
      , u = i(117)
      , m = {};
    "undefined" != typeof window && (m.create = i(12),
    m.update = i(11),
    m.draw = i(3));
    let p = 0;
    e.exports = class extends s {
        ...
        updateBounds() {
            ...
            i - t < o.pageMetrics.windowHeight ? (e.min = this.convertScrollPositionToTValue(t - .5 * o.pageMetrics.windowHeight),
            e.max = this.convertScrollPositionToTValue(i + .5 * o.pageMetrics.windowHeight)) : (e.min -= .001,
            e.max += .001),
        ...
        performTimelineDispatch() {
            ...
            this.timelineUpdateRequired = !1,
            this.position.lastPosition !== this.position.local && (this.position.lastPosition <= this.boundsMin && this.position.localUnclamped > this.boundsMin ? (this.trigger(o.EVENTS.ON_TIMELINE_START, this),
            this.trigger("start", this)) : this.position.lastPosition >= this.boundsMin && this.position.localUnclamped < this.boundsMin ? (this.trigger(o.EVENTS.ON_TIMELINE_START + ":reverse", this),
            this.trigger("start:reverse", this)) : this.position.lastPosition <= this.boundsMax && this.position.localUnclamped >= this.boundsMax ? (this.trigger(o.EVENTS.ON_TIMELINE_COMPLETE, this),
            this.trigger("complete", this)) : this.position.lastPosition >= this.boundsMax && this.position.localUnclamped < this.boundsMax && (this.trigger(o.EVENTS.ON_TIMELINE_COMPLETE + ":reverse", this),
        ...
        updateTimeline(e) {
            ...
            (r || o) && (this.performTimelineDispatch(),
            this.requestDOMChange(),
    ...
    class a extends n.default {
        _addKeyframesToImages() {
            ...
            this._images.forEach((e=>{
                ...
                if (e.closest(`[${r.CONTENT_WRAPPER_ATTRIB}]`))
                    e[o] = t;
                else {
...
, function(e, t, i) {
    ...
    class a extends s {
        ...
        _setupListeners(e) {
            if (e !== a.CHANGE_EVENTS.RETINA || this.listenersAdded.retina || (window.matchMedia(r).addListener(this._onRetinaChange),
            this.listenersAdded.retina = !0),
            e !== a.CHANGE_EVENTS.ORIENTATION || this.listenersAdded.orientation || (window.matchMedia(o).addListener(this._onOrientationChange),
...
, function(e, t, i) {
    ...
    class u extends r.default {
        ...
        destroy() {
            ...
            (0,
            n.default)((()=>{
                this.featureDetect && this.featureDetect !== a.FEATURE_ENHANCED && this.gum && this.anim.forceUpdate(),
                super.destroy()
            }
            )))
        }
        ...
        async unenhanceFeatureClass() {
            this.featureDetect && this.featureDetect !== a.FEATURE_ENHANCED && await h.removeFeatureDetectClass(this.featureDetect),
            (0,
...
, function(e, t, i) {
    ...
    o.DATA_ATTRIBUTE = "data-anim-event",
    e.exports = o
}
, function(e, t, i) {
    "use strict";
    ...
    class a extends s {
        ...
        addComponent(e) {
            ...
            if (!a.componentIsSupported(n, i))
                return void 0 === o[i] && (console.log("BubbleGum::addComponent unsupported component '" + i + "'. Reason: '" + i + ".IS_SUPPORTED' returned false"),
                o[i] = !0),
                null;
        ...
        removeComponent(e) {
            ...
            e.el.dataset[this.attribute] = e.el.dataset[this.attribute].split(" ").filter((t=>t !== e.componentName)).join(" "),
            e.destroy())
        }
...
, function(e, t, i) {
    ...
    t.setupViewportTracker = t.removeFeatureDetectClass = t.isSmallOnDesktop = t.addFeatureDetectClass = void 0;
    var n = s(i(3))
      , r = s(i(147))
      , o = function(e, t) {
        if (!t && e && e.__esModule)
    ...
    t.setupViewportTracker = e=>{
        ...
        return r.on(o.EVT_VIEWPORT_GROUP_CHANGED, n),
        n(r),
        s
    }
    ;
    t.isSmallOnDesktop = ()=>!(0,
...
, function(e, t, i) {
    ...
    e.exports = function(e, t) {
        var i, n, r, o, a, l, h;
        return t ? (n = (i = e.getBoundingClientRect()).top,
        r = i.left,
        o = i.width,
        a = i.height,
        e.offsetParent && (n -= (l = e.offsetParent.getBoundingClientRect()).top,
        r -= l.left)) : (h = s(e, t),
        n = e.offsetTop,
        r = e.offsetLeft,
        o = h.width,
    ...
    class m extends o.default {
        ...
        _findButton() {
            ...
            if (!e) {
                ...
                for (const i of t)
                    e = "PlayPause" === i.getAttribute("data-inline-media-control") ? i : i.querySelector(`${a}`)
            }
            return e
        }
...
, function(e, t, i) {
    ...
    class l extends r.default {
        ...
        async _swapSrc(e) {
            if (this._src = e,
            this.media.loadingState === n.default.EMPTY)
                return;
            const t = null !== this._cachedPlaying ? this._cachedPlaying : !this.media.el.paused;
            return this.media.loadingState === n.default.LOADED && (this._currentTime = this.media.el.currentTime),
...
, function(e, t, i) {
    ...
    const s = i(34)
      ...
      , d = i(136)
      , u = {};
    "undefined" != typeof window && (u.update = i(11),
    u.cancelUpdate = i(73),
    u.external = i(40),
    u.draw = i(3));
    let m = null;
    ...
    e.exports = "undefined" == typeof window ? new p : window.AC.SharedInstance.share("AnimSystem", d.major, p),
    e.exports.default = e.exports
}
, function(e, t, i) {
    "use strict";
...
, function(e, t, i) {
    ...
    class L {
        constructor(e) {
            ...
            this.tokens = []; (t = this.getNextToken()) && t !== C.EOF; )
                this.tokens.push(t);
            this.tokens.push(t)
        }
        advance() {
    ...
    class D {
        ...
        factor() {
            ...
            if (this.currentToken.type === g || this.currentToken.type === E) {
                ...
                if (this.pos += 1,
                b.OPERATOR.test(this.currentToken.value) || this.currentToken.type === u || this.currentToken.type === v || this.currentToken.type === y)
                    return e;
        ...
        unit() {
            ...
            if (t.type === c && e.test(t.value))
                return this.consume(c),
                new C(c,t.value = t.value.replace(/%(h|w)/, "$1").replace("%", "h"));
        ...
        parse() {
            const e = this.expr();
            return this.currentToken !== C.EOF && this.error(`Unexpected token ${this.currentToken.value}`),
            e
        }
    }
    class R {
...
, function(e, t, i) {
    ...
    const s = i(4)
      ...
      , u = i(120)
      , m = {};
    "undefined" != typeof window && (m.update = i(11),
    m.external = i(40),
    m.draw = i(3));
    const {transformAttributes: p, cssAttributes: f, domAttributes: _} = i(63)
      , g = i(125)
      , E = i(35)
      , v = i(126)
      , y = Math.PI / 180
    ...
    function h(e) {
        ...
        f = t[0] < .001 && t[0] >= 0 && t[1] < .001 && t[1] >= 0 ? [0, 0, n(180 * Math.atan2(d[0][1], d[0][0]) / Math.PI)] : function(e) {
            const [t,i,r,o] = e
              ...
              , c = t * i + r * o
              , d = o * o + a + l + h;
            return c > .49999 * d ? [0, 2 * Math.atan2(t, o) * s, 90] : c < -.49999 * d ? [0, -2 * Math.atan2(t, o) * s, -90] : [n(Math.atan2(2 * t * o - 2 * i * r, 1 - 2 * a - 2 * h) * s), n(Math.atan2(2 * i * o - 2 * t * r, 1 - 2 * l - 2 * h) * s), n(Math.asin(2 * t * i + 2 * r * o) * s)]
        }(t),
        {
            translation: c,
            rotation: f,
...
, function(e, t, i) {
    "use strict";
    var s, n = "undefined" != typeof window ? window : {}, r = "SharedInstance", o = n.AC, a = (s = {},
    {
        get: function(e, t) {
            var i = null;
...
, function(e, t, i) {
    "use strict";
    const {trim: s, getStringNumbers: n, getStringNonNumbers: r, reconstructStringWithNumbers: o} = i(128)
      , a = /^\s*?M[(-?\d)|\s]/
...
, function(e, t, i) {
    ...
    e.exports = class extends s {
        ...
        addKeyframe(e, t) {
            ...
            [["onStart", "once"], ["onDraw", "on"]].forEach((e=>{
                let[i,s] = e;
                if (!t[i])
                    return;
                let r = t[i];
...
, function(e, t, i) {
    ...
    class a extends n.default {
        ...
        _onMatch(e) {
            ...
            this._events && this.trigger(o, this)
        }
        destroy() {
            this._mql.removeEventListener ? this._mql.removeEventListener("change", this._onMatch) : this._mql.removeListener(this._onMatch),
            super.destroy()
        }
    }
            ...
            const e = {
                ...
                itemsCreated() {
                    Object.values(this.items).forEach((e=>{
                        ...
                        ,
                        e.imageEl = this.el.parentElement.querySelector(`.${e.key}-image`),
                        e.el.classList.contains("expanded") && e.imageEl.setAttribute("aria-hidden", "false")
                    }
                    )),
                ...
                _handleImagesLoad() {
                    this.imagesCounter++,
                    this.imagesCounter >= this._els.accordionImages.length && this._responsiveScalePictures()
                },
                onItemChangeInitiated(e) {
                    this._toggleAccordionItems(e)
                },
                onResizeImmediate(e) {
                    const t = e.breakpoint !== e.previousBreakpoint && "" !== e.previousBreakpoint;
                    this.imagesCounter >= this._els.accordionImages.length && !t && this._responsiveScalePictures(),
                    this._accordionHeightRemoved || (this.el.style.removeProperty("--accordion-height"),
                ...
                _cacheSizeInfo() {
                    ...
                    new Promise(((t,i)=>{
                        ...
                        c.update)((()=>{
                            ...
                            (0,
                            c.draw)((()=>{
                                this.el.style.setProperty("--accordion-height", `${e}px`),
              ...
              , t = n.default.withMixins(e, r.default, o.default, a.default, l.default, h.default)
              , i = this.el;
...
, function(e, t, i) {
    ...
    const s = i(7)
      ...
      , r = i(162)
      , o = i(163)
      , a = ["beforeCreate", "created", "beforeMount", "createItems", "itemsCreated", "mounted", "animateItem", "onItemChangeInitiated", "onItemChangeCompleted", "onResizeImmediate", "onBreakpointChange", "onResizeDebounced", "destroy"];
    class l extends s {
        constructor(e) {
            var t;
            super(e),
    ...
    l.withMixins = function() {
        ...
        s.forEach((e=>{
            for (const i in e)
                a.includes(i) ? (t[`__${i}`] = t[`__${i}`] || [],
                t[`__${i}`].push(e[i])) : t[i] = e[i]
        }
        )),
        e
    }
...
, function(e, t, i) {
    ...
    const s = i(6).EventEmitterMicro
      ...
      , o = {};
    "undefined" != typeof window && (o.draw = i(3),
    o.cancelDraw = i(52));
    e.exports = class extends s {
        constructor(e) {
            super(),
        ...
        setupItemElements() {
            ...
            t && (this.parentKey = t.dataset.accordionItem,
            this.parentExpanded = t.classList.contains(this.model.Item.ExpandedClassName)),
        ...
        needsRedraw() {
            o.cancelDraw(this._rafID),
            this._rafID = o.draw(this.applyDraw, !0)
        }
        applyDraw() {
...
, function(e, t, i) {
    ...
    l._clickProxy = function(e, t, i, s) {
        ...
        r.indexOf(n) < 0 && o("element's role is not set to any of the following " + r.join(", ")),
...
, function(e, t, i) {
    ...
    ,
    d.addNavItem = function(e) {
        e && e.nodeType && this._navItems.indexOf(e) < 0 && (a(e.getAttribute(s.DISABLED)) || this._disableElement(e),
        this._navItems.push(e))
    }
    ,
    ...
    e.exports = {
        ...
        itemsCreated() {
            Object.values(this.items).forEach((e=>{
                ...
                t && (e.isExpanded() && this.removeItemClickAttribute(e),
        ...
        _bindAnalyticsItemEvents(e) {
            e.on(this.model.Item.Events.expanded, (()=>this.removeItemClickAttribute(e))),
            e.on(this.model.Item.Events.collapsed, (()=>this.setItemClickAttribute(e, this.analytics.clickValues[e.key])))
        },
        _updateToggleAllButtonClickAttribute() {
            this.toggleAllButton && this.toggleAllButton.toggleEls && this.toggleAllButton.toggleEls.forEach((e=>{
                ...
                r && (r = this._replaceStateString(r, i, s, n),
                e.setAttribute(this.analytics.attributes.click, r)),
                o && (o = this._replaceStateString(o, i, s, n),
        ...
        _replaceStateString(e, t) {
            let i = e;
            for (var s = arguments.length, n = new Array(s > 2 ? s - 2 : 0), r = 2; r < s; r++)
                n[r - 2] = arguments[r];
            for (let e of n)
                i.includes(e) && (i = i.replace(e, t));
            return i
        },
...
, function(e, t, i) {
    ...
    e.exports = {
        ...
        animateItem(e) {
            ...
            t.isCollapsing() && requestAnimationFrame((()=>{
                t.setTrayElHeight(0)
            }
            ));
...
, function(e, t, i) {
    ...
    e.exports = {
        onItemChangeInitiated(e) {
            const t = e.item;
            t.isExpandState() ? (t.initiateCollapse(),
            this.disableNestedTabbable(t)) : (t.initiateExpand(),
            this.enableNestedTabbable(t)),
            t.measure(),
            this.animateItem({
                accordion: this,
                item: t
...
, function(e, t, i) {
    "use strict";
    var s, n = i(12), r = i(6).EventEmitterMicro;
    function o(e, t) {
        r.call(this),
        t = t || {},
        this._fps = e || 0,
...
, function(e, t, i) {
    ...
    class h extends o.default {
        ...
        _createModal(e, t) {
            if (!e)
                return this.logger.error("An Modal for the following L1 element is unable to find the required content wrapper element", this.el),
                {};
            const i = e.hasAttribute(l.USE_ANIM_LIFECYCLE_ATTRIB) ? a.AnimLifecycleEvents : {}
              , s = e.querySelector(`.${l.ABSOLUTE_CAPTION_CLASSNAME}`) ? a.AbsoluteCaption : {};
...
, function(e, t, i) {
    ...
    class u extends n.default {
        ...
        static withMixins() {
            ...
            for (var i = arguments.length, s = new Array(i), n = 0; n < i; n++)
                s[n] = arguments[n];
            return [a.default, ...s, h.default, l.default].forEach((e=>{
                for (const i in e)
                    c.includes(i) ? (t[`__${i}`] = t[`__${i}`] || [],
                    t[`__${i}`].push(e[i])) : t[i] = e[i]
            }
            )),
            e
            ...
            for (const e in t)
                for (const i in t[e]) {
                    ...
                    if ("class" === i)
                        ...
                        this.elements[e].className = `${this.elements[e].className} ${s}`.trim();
                    else
...
, function(e, t, i) {
    ...
    e.exports = class extends s {
        ...
        destroy() {
            return this._context.removeEventListener(r, this._DOMKeyDown, !0),
...
, function(e, t, i) {
    ...
    const n = e=>{
        ...
        e.style.setProperty(s.CAPTION_CSS_VAR.SCALE_RATIO, parseFloat((e=>{
            const t = 1441
              , i = 1069
              , s = 735
              , n = 481;
            return e >= t ? 1 : e >= i ? e / (t - 1) : e >= s ? e / (i - 1) : e >= n ? e / (s - 1) : e / (n - 1)
        }
        )(t)))
    }
      , r = e=>{
        e.style.setProperty(s.CAPTION_CSS_VAR.WIDTH, e.querySelector(`.${s.ABSOLUTE_CAPTION_CLASSNAME}`).offsetWidth + "px")
    }
    ;
    t.default = {
        mounted() {},
            ...
            for (const e of t) {
                const t = 100 === e ? "b - 100vh" : `t + ${e}h - 100vh`
                  ...
                  , l = ()=>{
                    const t = r(e);
                    o.track(t),
                    s.DevLogger.info("Modal Track Depth", t)
                }
                ;
...
, function(e, t, i) {
    ...
    t.default = function(e, t) {
        ...
        if (!i)
            return s.DevLogger.warn("The following nested element does not appear to be in a Modal", t),
            null;
        const r = i.getAttribute(n.MODAL_COMPONENT_REF_ATTRIB);
        if (!r)
            return s.DevLogger.error(`The following Modal element appears to be missing the dynamically applied ${n.MODAL_COMPONENT_REF_ATTRIB} attribute`, i),
            null;
...
, function(e, t, i) {
    ...
    t.default = {
        beforeCreate() {
            ...
            this.friendlyName = (0,
            s.getFriendlyName)(this.elements.content)
        },
        beforeMount() {
...
, function(e, t, i) {
    ...
    t.default = Object.assign({}, s.Close, {
        ...
        close(e) {
            this.opened && (e && "click" === e.type && !this.elements.close.includes(e.target) || (this.opened = !1,
    ...
    const r = i(76)
      , o = {
        ...
        onEnterOnce: e=>{
            ...
            e.element.forceLoad ? e.element.forceLoad() : e.element.forceLazyLoad && e.element.forceLazyLoad()
        }
    };
    t.default = {
        mounted() {
    ...
    t.default = {
        beforeCreate() {
            const e = this.elements.content.getAttribute(s.THEME_ATTRIB)
              ...
              , i = this.elements.content.getAttribute(s.MODAL_CUSTOM_CLASSNAME_ATTRIB)
        ...
        setupGallery() {
            const e = {
                beforeCreate() {
                    ...
                    this._onClickScrollToFirst = this._onClickScrollToFirst.bind(this),
                ...
                mounted() {
                    ...
                    this._itemsACMI = this._items.filter((e=>!("acmi" === e.el.getAttribute("data-toggle")))),
                    this._checkACMI()
                },
                ...
                _checkPaddlenav() {
                    const e = this.el.querySelector(".paddlenav")
                      , t = e.querySelector(".paddlenav-arrow-previous").hasAttribute("disabled")
                      , i = e.querySelector(".paddlenav-arrow-next").hasAttribute("disabled");
                    t && i ? (e.classList.add("hide"),
                    this.el.classList.add("no-paddlenav")) : (e.classList.remove("hide"),
                ...
                _addScrollToFirst() {
                    ...
                    i && (this.paddleNav.previousEl.addEventListener("click", this._onClickScrollToFirst),
                    this.isPrevEventAdded = !0),
                    s && (this.paddleNav.previousEl.removeEventListener("click", this._onClickScrollToFirst),
                    this.isPrevEventAdded = !1)
                },
                _checkACMI() {
...
, function(e, t, i) {
    ...
    const s = i(6).EventEmitterMicro
      , n = {};
    "undefined" != typeof window && (n.draw = i(3),
    n.cancelDraw = i(52));
    e.exports = class extends s {
        constructor(e) {
            super(),
    ...
    e.exports = {
        ...
        cacheSizeInfo() {
            ...
            this._items.forEach(((e,i)=>{
                ...
                this.itemOffsets.push(s * this.dir)
            }
            ))
        },
        onResizeImmediate() {
    ...
    e.exports = {
        created(e) {
            const t = ()=>{
                ...
                return Object.defineProperty(this, "isInView", {
                    configurable: !0,
            ...
            ;
            this.el.hasAttribute("select-gallery-item-kf") ? this.el.addEventListener("switch-gallery", (e=>{
                for (const e in n)
                    n[e].remove();
                if (this.inViewKeyframe = null,
                e.target.classList.contains("active")) {
                    const i = t();
                    this.inViewKeyframe = i,
                    n[e.target.id] = i
                }
            }
    ...
    class a extends n.default {
        ...
        setupToggle() {
            ...
            this.selectToggleNav.addEventListener("transitionend", (r=>{
                r.target === i && (s.classList.add("active"),
                this.currentGallery = Array.from(this.galleries).find((e=>e.id === n)),
                this.currentGallery.classList.add("active"),
        ...
        setupStickyOffset() {
            ...
            this.currentGallery.style.setProperty("--select-sticky-offset", `${e}px`)
        }
        setGalleryHeight() {
            let e = 0
              , t = 0;
...
, function(e, t, i) {
    ...
    e.exports = class {
        constructor(e) {
            ...
            this._items = [...this.el.querySelectorAll(this._options.itemSelector)],
            this._isRightToLeft = "rtl" === window.getComputedStyle(this.el).direction,
        ...
        centerItem(e, t) {
            ...
            const i = .5 * s(this.el).width
              , r = n(e).left + .5 * s(e).width;
            let o = Math.round(r - i);
            t ? this.el.scrollLeft = this._setNormalizedScroll(o) : (this._destroyCurrentClip(),
            this._isRightToLeft && (o *= -1),
            this._smoothScrollTo(o))
        }
        _initializePaddles() {
            const e = this._isRightToLeft ? this._options.rightPaddleSelector : this._options.leftPaddleSelector
        ...
        _updatePaddleDisplay() {
            const e = this._getNormalizedScroll(this._scrollStart) + this._wrapperWidth;
        ...
        _getPaddleStartScrollDestination() {
            ...
            for (let i = this._childCount - 1; i > 0; i--)
                if (t = this._normalizePosition(n(this._children[i])),
        ...
        _getNormalizedScroll(e) {
            return this._isRightToLeft ? "default" === this._scrollType ? this._contentWidth - this._wrapperWidth - Math.abs(e) : Math.abs(e) : e
        }
        ...
        _destroyPaddles() {
            this._paddles && (this._wrapper.removeEventListener("scroll", this._onScroll),
...
, function(e, t, i) {
    ...
    class r extends n.default {
        constructor(e) {
            super(e),
            this.kf = null,
            this.staggeredAnchor = this.el.querySelector("[data-staggered-anchor]") || this.el,
            this.staggeredItems = this.el.querySelectorAll("[data-staggered-item]"),
            this.staggeredBeforeItems = this.el.querySelectorAll("[data-staggered-before-item]"),
            ...
            this.OPACITY_DURATION = Number(t.getPropertyValue("--global-staggered-opacity-duration")),
            this.TRANSLATE_Y = t.getPropertyValue("--global-staggered-translate-y"),
            this.TRANSLATEY_DURATION = Number(t.getPropertyValue("--global-staggered-translate-y-duration"))
        }
        mounted() {
            this.setupTimeline(),
            this.setUpKeyframes()
        ...
        setupTimeline() {
            ...
            this.staggeredRestart && this.anim.addEvent(this.staggeredAnchor, {
                start: "t - 100vh",
                event: "staggered-restart",
                onEventReverse: ()=>{
                    this.timeGroup.restart(),
                    this.timeGroup.pause()
                }
            })
        }
        setUpKeyframes() {
            let e = null !== this.selectGallery ? this.firstGalleryItems : this.staggeredItems;
            e = [...this.staggeredBeforeItems, ...e];
            let t = e.length - 1;
            e.forEach(((e,t)=>{
                e && e.hasAttribute("data-staggered-children") ? (this.itemChildren = e.querySelectorAll(":scope > *"),
        ...
        staggeredKeyframes(e, t) {
            ...
            this.animKeyframes.push(i),
            this.animKeyframes.push(s)
        }
        destroy() {
            let e = [];
        ...
        _setMaxRowHeights() {
            this._gridColumns.forEach((e=>{
                for (const [t,i] of Object.entries(this._gridRowConfig))
                    t.startsWith("plus-row-") ? e.style.setProperty(`${i.var}`, `minmax(${i.maxHeight}px, max-content)`) : e.style.setProperty(`${i.var}`, `${i.maxHeight}px`)
            }
            ))
        }
        onBreakpointChange() {
...
, function(e, t, i) {
    ...
    class o extends n.default {
        ...
        addKeyframes() {
            this.configureAnimationProps(),
            this.configureScrollKeyframes()
        }
...
, function(e, t, i) {
    ...
    class l extends o.default {
        ...
        _initialize() {
            ...
            const e = (0,
            r.default)(this.media.el.dataset, this.options, "loadKeyframe", a);
        ...
        async _onLoadKeyframeEnter(e) {
            try {
                ...
                (0,
                n.default)("AnimLoad: Load error occured")
            }
        }
        ...
        mounted() {
            "none" !== this.media.el.preload && this.media.src && (async()=>{
                try {
                    ...
                    (0,
                    n.default)(`auto load of ${this.media.src} failed or was aborted with err:${e}`)
                }
            }
            )()
        }
...
, function(e, t, i) {
    ...
    function o(e, t, i) {
        for (var s, n, o = e.length, a = 0; a < o; a++)
            if ("function" == typeof e[a].test ? !0 === e[a].test(i) && (s = e[a].name) : i.ua.indexOf(e[a].userAgent) > -1 && (s = e[a].name),
            s) {
                if (t[s] = !0,
                "string" == typeof (n = r(e[a], i.ua))) {
                    var l = n.split(".");
                    t.version.string = n,
    ...
    e.exports = function(e) {
        var t = {};
        return t.browser = o(n.browser, s.browser, e),
        t.os = o(n.os, s.os, e),
        t
    }
}
...
, function(e, t, i) {
    ...
    class d extends n.default {
        ...
        mounted() {
            ...
            this.mediaInstance.el.addEventListener(r.default.CAN_PLAY_THROUGH, (()=>{
                this.handleAutoplay()
            }
            ))
        }
        addListeners() {
            ...
            this.button.addEventListener("click", (e=>{
                e.target.focus(),
                "playing" === this.mediaInstance.playbackState ? this.userPaused = !0 : "paused" === this.mediaInstance.playbackState && (this.userPaused = !1)
            }
            ))
        }
        handleAutoplay() {
            !(0,
            a.default)() && document.documentElement.classList.contains(h.FEATURE_ENHANCED) && this.mediaInstance.play()
        }
        configureKeyframes() {
            this.enhancedScrollGroup.addEvent(this.video, {
                ...
                onEventReverse: ()=>{
                    (0,
                    a.default)() || this.userPaused || (this.mediaInstance.play(),
                    this.userPaused = !1)
                }
            })
        }
    ...
    e.exports = class {
        constructor(e, t) {
            ...
            this.options = {
                ...
                itemLabelClassname: t.itemLabelClassname || `${t.componentName}-label`,
                itemNewClassname: t.itemNewClassname || `${t.componentName}-new`,
                leftPaddleClassname: t.leftPaddleClassname || `${t.componentName}-paddle-left`,
                rightPaddleClassname: t.rightPaddleClassname || `${t.componentName}-paddle-right`,
        ...
        isChapternavTall() {
            ...
            let t = !1;
            return e.forEach((e=>{
                e.querySelector(`.${this.options.itemLabelClassname}`).getElementsByTagName("BR").length > 0 && (t = !0)
            }
            )),
            t
        }
...
, function(e, t, i) {
    ...
    e.exports = class {
        constructor(e) {
            ...
            this._wrapper = this.el.querySelector(`.${this._options.itemsClassname}`),
            this._items = [...this.el.querySelectorAll(`.${this._options.itemClassname}`)],
            this._isRightToLeft = "rtl" === window.getComputedStyle(this.el).direction,
            this._inlineStart = this._isRightToLeft ? "right" : "left",
            this._inlineEnd = this._isRightToLeft ? "left" : "right",
            this.lastCenteredItem = this._items[0],
        ...
        centerItem(e, t) {
            this.lastCenteredItem = e;
            const i = .5 * n(this.el).width
              , s = r(e).left + .5 * n(e).width;
        ...
        _getPaddleStartScrollDestination() {
            ...
            let t;
            for (let i = this._childCount - 1; i > 0; i--)
                if (t = this._normalizePosition(r(this._children[i])),
                t[this._inlineStart] < e)
                    return t[this._inlineEnd] - this._wrapperWidth;
            return 0
        }
        ...
        _getNormalizedScroll(e) {
            return this._isRightToLeft ? this._isRightToLeft ? Math.abs(e) : void 0 : e
        }
        _setNormalizedScroll(e) {
            let t = this._getBoundedScrollX(e);
